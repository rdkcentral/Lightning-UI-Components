...
https://github.com/rdkcentral/Lightning-UI-Components/blob/develop/packages/@lightningjs/ui-components/src/components/FocusManager/FocusManager.js

## Usage

To use the FocusManager component, define it within the `_template()` function of your parent component and return it from the `_getFocused()` function.
