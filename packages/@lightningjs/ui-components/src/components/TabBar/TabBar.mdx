...
to render for each tab is the [Tab](/docs/components-tab--basic) component, however custom implementations of tab components is also supported.
...
<Canvas>
  <Story id="components-tabbar--basic" />
</Canvas>
