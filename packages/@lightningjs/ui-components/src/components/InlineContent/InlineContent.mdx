...
https://github.comcast.com/Lightning/lightning-ui/blob/develop/packages/@lightningjs/ui-components/src/components/InlineContent/InlineContent.js
...
```js
import { InlineContent } from '@lightningjs/ui';
