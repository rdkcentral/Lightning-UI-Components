...
https://github.com/rdkcentral/Lightning-UI-Components/blob/develop/packages/@lightningjs/ui-components/src/components/MetadataBase/MetadataBase.js
...
```js
import { MetadataBase } from '@lightningjs/ui';
