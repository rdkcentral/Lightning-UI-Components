...
| iconX                  | number                | horizontal position of icon within the tile                                                                                                                                                                           |
| iconYInset             | number                | vertical icon position within the tile when metadataLocation is inset                                                                                                                                                 |
| iconYStandard          | number                | vertical icon position within the tile when metadataLocation is standard                                                                                                                                              |
