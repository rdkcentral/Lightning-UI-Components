...
TextBox also accepts inline content arrays and strings which are rendered using the [InlineContent](/docs/components-inlinecontent--test) component.
...
<Canvas>
  <Story id="components-textbox--basic" />
</Canvas>
