...
https://github.comcast.com/Lightning/lightning-ui/blob/develop/packages/@lightningjs/ui-components/src/mixins/withAnnouncer/index.js
...
```js
import { withAnnouncer } from '@lightningjs/ui'
