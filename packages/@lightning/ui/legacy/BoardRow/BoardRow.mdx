...
https://github.comcast.com/Lightning/lightning-ui/packages/@lightning/ui-core/src/components/BoardRow/BoardRow.js
...
<Canvas>
  <Story id="patterns-boardrow--basic" />
</Canvas>
...
| itemSpacing  | number   | false    | 0         | Space in px between items.                                                                                                                                                                                                                                                                                                         |
...
The menuCard object will accept the following properties

| name          | type       | required | default   | description                                                |
| ------------- | ---------- | -------- | --------- | ---------------------------------------------------------- |
| title         | string     | true     | undefined | Text to be displayed as title for menu card.               |
| description   | string     | false    | undefined | Text to be displayed under the title of the menu card.     |
| cta           | string     | false    | undefined | Text to be displayed at the bottom of the menu card.       |
| gradientColor | string:hex | false    | undefined | Gradient color to be displayed at the bottom of menu card. |
