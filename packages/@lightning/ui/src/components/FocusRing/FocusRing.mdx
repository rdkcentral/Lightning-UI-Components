...
https://github.comcast.com/Lightning/lightning-ui/blob/develop/packages/@lightning/ui/src/components/FocusRing/FocusRing.js
...
<Canvas>
  <Story id="foundations-focusring--focus-ring" />
</Canvas>
