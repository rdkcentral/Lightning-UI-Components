...
https://github.comcast.com/Lightning/lightning-ui/blob/develop/packages/@lightning/ui-core/src/mixins/withLayout/index.js
...
<Canvas>
  <Story id="utilities-withlayout--base" />
</Canvas>
