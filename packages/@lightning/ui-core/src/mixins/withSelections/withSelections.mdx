...
<Canvas>
  <Story id="utilities-withselections--base" />
</Canvas>
...
https://github.comcast.com/Lightning/lightning-ui/packages/@lightning/ui-core/src/components/withSelections/withSelections.js
