...
https://github.comcast.com/Lightning/lightning-ui/blob/develop/packages/@lightning/ui-core/src/components/ControlRow/ControlRow.js
...
<Canvas>
  <Story id="navigation-controlrow--control-row" />
</Canvas>
