...
https://github.comcast.com/Lightning/lightning-ui/blob/develop/packages/@lightning/ui-core/src/components/InlineContent/InlineContent.js
...
<Canvas>
  <Story id="text-inlinecontent--inline-content" />
</Canvas>
