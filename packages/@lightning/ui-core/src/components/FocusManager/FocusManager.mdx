...
import { DocsLink } from '../../../storybook/index.js';
...
https://github.comcast.com/Lightning/lightning-ui/packages/@lightning/ui-core/src/components/FocusManager/FocusManager.js
