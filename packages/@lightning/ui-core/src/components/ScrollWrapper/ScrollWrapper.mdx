...
| content         | string\|array | true     | undefined | Content is items that are viewable in the container. It can be an array of strings or an array of lightning elements that can be patched in |
