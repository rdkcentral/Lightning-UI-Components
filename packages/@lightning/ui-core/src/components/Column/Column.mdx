...
import { DocsLink, GenericType, ObjectFormat } from '../../../storybook/index.js';
...
https://github.comcast.com/Lightning/lightning-ui/packages/@lightning/ui-core/src/components/Column/Column.js
...
| ---------------- | ------------------------------------------------------- | -------- | --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --- |
| alwaysScroll     | boolean                                                 | false    | false     | determines whether the column will stop scrolling as it nears the bottom to prevent white space                                                                                                                                         |
| autoResizeWidth  | boolean                                                 | false    | false     | automatically sets the width of the column to be the same as the Items container inside                                                                                                                                                 |
| autoResizeHeight | boolean                                                 | false    | false     | automatically sets the height of the column to be the same as the Items container inside (this will prevent scrolling)                                                                                                                  |
...
| neverScroll      | boolean                                                 | false    | false     | false if true, the column will never scroll, unless alwaysScroll is set to true, and if false, the column will apply normal scrolling logic                                                                                             |
...
| scrollIndex      | number                                                  | false    | 0         | Item index at which scrolling begins, provided the sum of item heights is greater than the height of the `Column`                                                                                                                       |
