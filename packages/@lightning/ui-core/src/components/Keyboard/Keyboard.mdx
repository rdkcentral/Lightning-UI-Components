...
https://github.comcast.com/Lightning/lightning-ui/packages/@lightning/ui-core/src/components/Keyboard/Keyboard.js
...
| centerAlign   | bool          | false    | false   | center the keyboard within it's set width (must set the w property of Keyboard)                                                               |
