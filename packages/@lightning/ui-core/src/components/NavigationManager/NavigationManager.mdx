...
https://github.comcast.com/Lightning/lightning-ui/blob/develop/packages/@lightning/ui-core/src/components/NavigationManager/NavigationManager.js
...
```js
import { NavigationManager } from '@lightning/ui';
