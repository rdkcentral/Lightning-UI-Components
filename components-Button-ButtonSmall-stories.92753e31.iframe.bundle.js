"use strict";
(self["webpackChunklightning_ui_docs"] = self["webpackChunklightning_ui_docs"] || []).push([[6610,7721,9134,5278,1977,11,4759,6115,1661,4827,9725,1655,287,547,1323,7987,3153,3375,7771,8197,2877,9861,9459,3597],{
...
function getCommponentArray(comps) {
  ...
  switch (comps) {
    ...
    case 'checkbox':
      arr = [{
        type: _Checkbox__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A,
        checked: true
      }];
      break;
    case 'combo':
...
var sharedArgTypes = _objectSpread(_objectSpread({}, (0,_docs_utils__WEBPACK_IMPORTED_MODULE_4__/* .createModeControl */ .Pg)({
  ...
  fixed: {
    control: 'boolean',
    description: _docs_constants__WEBPACK_IMPORTED_MODULE_5__/* .controlDescriptions */ .Hx.fixed,
    table: {
      defaultValue: {
        summary: false
      }
...
};;const __namedExportsOrder = ["ButtonSmall"];
...
//# sourceMappingURL=components-Button-ButtonSmall-stories.92753e31.iframe.bundle.js.map