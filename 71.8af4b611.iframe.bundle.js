"use strict";
(self["webpackChunklightning_ui_docs"] = self["webpackChunklightning_ui_docs"] || []).push([[71],{
...
var Button = /*#__PURE__*/function (_Surface) {
  ...
  _createClass(Button, [{
    ...
    key: "_updatePrefixStyles",
    value: function _updatePrefixStyles() {
      var _this = this;
      this._Prefix.Items.children.forEach(function (item, idx) {
        item.color = Array.isArray(_this.prefix) ? _this.prefix[idx].color : _this.prefix.color;
    ...
    value: function _updateSurfaceDimensions() {
      ...
      if (this.fixed) {
        ...
        newWidth = !this._hasTitle && (this._hasPrefix || this._hasSuffix) || this._Title && !this._Title.visible && (this._hasPrefix || this._hasSuffix) ? this._contentW + this._paddingX : Math.max(this._contentW + this._paddingX, this.style.minWidth);
      }
      if (newWidth !== this.w) {
        this.w = newWidth;
      }
