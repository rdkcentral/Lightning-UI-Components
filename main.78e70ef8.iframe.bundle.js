...
var Badge = /*#__PURE__*/function (_Base) {
  ...
  _createClass(Badge, [{
    ...
    value: function _updateBackground() {
      ...
      this.patch({
        h: height,
        texture: lightning_esm/* default */.Z.Tools.getRoundRect(this.w, height, (0,utils/* getMaxRoundRadius */.JS)(this.style.radius, this.w, height), this.style.strokeWidth, this.style.strokeColor, true, this.style.backgroundColor)
      });
    }
  }, {
    key: "_updateText",
...
function withAnnouncer(Base) {
  var speak = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _Speech__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z;
      ...
      value: function _voiceOut(toAnnounce) {
        ...
        if (announcerOptions.abbreviationsConfig.abbreviationsPattern) {
          toSpeak = Array.isArray(toAnnounce) ? toAnnounce.map(function (phrase) {
            return (0,_abbreviations__WEBPACK_IMPORTED_MODULE_1__/* .translateAbbrev */ .e5)(phrase, announcerOptions.abbreviationsConfig);
          }) : (0,_abbreviations__WEBPACK_IMPORTED_MODULE_1__/* .translateAbbrev */ .e5)(toAnnounce, announcerOptions.abbreviationsConfig);
        }
  ...
  return /*#__PURE__*/function (_Base) {
    ...
    _createClass(_class, [{
      ...
      value: function _invokeKeyPayloadCallback(key) {
        if (this.metricsPayload && typeof _globals_context_index__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z.keyMetricsCallback === 'function') {
          _globals_context_index__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z.keyMetricsCallback(key, this.metricsPayload);
        }
      }
    }], [{
      key: "name",
  ...
  return /*#__PURE__*/function (_Base) {
    ...
    _createClass(_class, [{
      ...
      value: function queueRequestUpdate() {
        if (!this._isAttached()) return;
        _globals_global_update_manager_GlobalUpdateManager__WEBPACK_IMPORTED_MODULE_1__/* .updateManager */ .Y.addRequestUpdate(this);
      }
    }, {
      key: "_firstEnable",
      value: function _firstEnable() {
        ...
        _globals_global_update_manager_GlobalUpdateManager__WEBPACK_IMPORTED_MODULE_1__/* .updateManager */ .Y.deleteRequestUpdate(this);
        this.requestUpdate();
        _get(_getPrototypeOf(_class.prototype), "_firstEnable", this) && _get(_getPrototypeOf(_class.prototype), "_firstEnable", this).call(this);
      }
    }, {
      ...
      value: function requestEarlyUpdate() {
        this._readyForUpdates = true;
        if (_globals_global_update_manager_GlobalUpdateManager__WEBPACK_IMPORTED_MODULE_1__/* .updateManager */ .Y.hasQueuedRequestFor(this)) {
          _globals_global_update_manager_GlobalUpdateManager__WEBPACK_IMPORTED_MODULE_1__/* .updateManager */ .Y.deleteRequestUpdate(this);
        ...
        if (this._readyForUpdates || force) {
          ...
          if (_typeof(result) === 'object' && result !== null && result["catch"]) {
            ...
            result["catch"](function (e) {
              _globals_context__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z.error("asyncronous _update() error in '".concat(_this2.constructor.__componentName, "'"), _this2, e);
            });
          }
        }
      }
...
/* harmony export */   JS: () => (/* binding */ getMaxRoundRadius),
