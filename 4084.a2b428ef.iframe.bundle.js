  ...
  _createClass(Toggle, [{
    ...
    value: function _updateKnobPosition() {
      var _this$style = this.style,
        knobXChecked = _this$style.knobXChecked,
        knobX = _this$style.knobX,
        knobPadding = _this$style.knobPadding,
        knobWidth = _this$style.knobWidth,
        strokeWeight = _this$style.strokeWeight;
      this._knobX = knobX || strokeWeight + knobPadding;
      this._knobXChecked = knobXChecked || this.w - strokeWeight - knobPadding - knobWidth;
      var x = this.checked ? this._knobXChecked : this._knobX;
    ...
    value: function _updateContainer() {
      var _this$style3 = this.style,
        ...
        strokeWeight = _this$style3.strokeWeight;
      var radius;
      ...
      this._Container.patch({
        w: this.w,
        h: this.h,
        texture: lightning_esm/* default */.Z.Tools.getRoundRect(this.w - 2 * strokeWeight, this.h - 2 * strokeWeight, radius, strokeWeight, 0, true, false)
      });
    }
  }, {
    key: "_updateStroke",
    value: function _updateStroke() {
      var _this$style4 = this.style,
        ...
        strokeWeight = _this$style4.strokeWeight;
      this._Stroke.patch({
        w: this.w,
        h: this.h,
        texture: lightning_esm/* default */.Z.Tools.getRoundRect(this.w, this.h, strokeRadius !== undefined ? strokeRadius : knobRadius + knobPadding + strokeWeight, strokeWeight, strokeColor, false, false)
      });
    }
  }, {
    key: "_updateKnob",
    value: function _updateKnob() {
      ...
      this._Knob.patch({
        ...
        texture: lightning_esm/* default */.Z.Tools.getRoundRect(knobWidth - 2, knobHeight - 2, knobRadius, 0, 0, true, false)
      });
    }
  }, {
    key: "_setChecked",
...
//# sourceMappingURL=4084.a2b428ef.iframe.bundle.js.map