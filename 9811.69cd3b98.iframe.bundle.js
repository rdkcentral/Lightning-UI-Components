"use strict";
(self["webpackChunklightning_ui_docs"] = self["webpackChunklightning_ui_docs"] || []).push([[9811],{

/***/ "../../@lightningjs/ui-components/src/components/TabBar/Tab.js":
...
// NAMESPACE OBJECT: ../../@lightningjs/ui-components/src/components/TabBar/Tab.styles.js
var Tab_styles_namespaceObject = {};
__webpack_require__.r(Tab_styles_namespaceObject);
__webpack_require__.d(Tab_styles_namespaceObject, {
  base: () => (base),
  mode: () => (mode),
  tone: () => (tone)
});
...
;// CONCATENATED MODULE: ../../@lightningjs/ui-components/src/components/TabBar/Tab.styles.js
...
;// CONCATENATED MODULE: ../../@lightningjs/ui-components/src/components/TabBar/Tab.js
...
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, Tab_toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function set(target, property, value, receiver) { if (typeof Reflect !== "undefined" && Reflect.set) { set = Reflect.set; } else { set = function set(target, property, value, receiver) { var base = _superPropBase(target, property); var desc; if (base) { desc = Object.getOwnPropertyDescriptor(base, property); if (desc.set) { desc.set.call(receiver, value); return true; } else if (!desc.writable) { return false; } } desc = Object.getOwnPropertyDescriptor(receiver, property); if (desc) { if (!desc.writable) { return false; } desc.value = value; Object.defineProperty(receiver, property, desc); } else { Tab_defineProperty(receiver, property, value); } return true; }; } return set(target, property, value, receiver); }
...
function Tab_toPropertyKey(t) { var i = Tab_toPrimitive(t, "string"); return "symbol" == Tab_typeof(i) ? i : String(i); }
...
var Tab = /*#__PURE__*/function (_Surface) {
  _inherits(Tab, _Surface);
  ...
  _createClass(Tab, [{
    ...
    value: function _update() {
      _get(_getPrototypeOf(Tab.prototype), "_update", this).call(this);
      this._updateIcon();
      this._updateText();
      this._updateContent();
      this._updateTabSize();
    ...
    set: function set(announce) {
      _set(_getPrototypeOf(Tab.prototype), "announce", announce, this, true);
    }
  }], [{
    key: "_template",
    value: function _template() {
      return Tab_objectSpread(Tab_objectSpread({}, _get(_getPrototypeOf(Tab), "_template", this).call(this)), {}, {
        Content: {
          mount: 0.5,
          x: function x(w) {
            return w / 2;
    ...
    key: "__themeStyle",
    get: function get() {
      return Tab_styles_namespaceObject;
    }
  }, {
    key: "__componentName",
    get: function get() {
...
//# sourceMappingURL=9811.69cd3b98.iframe.bundle.js.map