"use strict";
(self["webpackChunklightning_ui_docs"] = self["webpackChunklightning_ui_docs"] || []).push([[6179],{
...
/* harmony import */ var _globals__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("../../@lightningjs/ui-components/src/globals/context/index.js");
...
var _Row$parameters, _Row$parameters2, _Row$parameters3, _FocusHeightChange$pa, _FocusHeightChange$pa2, _VaryingItemWidth$par, _VaryingItemWidth$par2, _ExpandableWidth$para, _ExpandableWidth$para2, _CenteredInParent$par, _CenteredInParent$par2, _Plinko$parameters, _Plinko$parameters2, _SkipFocus$parameters, _SkipFocus$parameters2, _LazyScrollIndexes$pa, _LazyScrollIndexes$pa2, _AddingItems$paramete, _AddingItems$paramete2, _LazyUpCount$paramete, _LazyUpCount$paramete2, _RemovingItems$parame, _RemovingItems$parame2;
...
var sharedArgTypes = _objectSpread(_objectSpread({}, (0,_docs_utils__WEBPACK_IMPORTED_MODULE_1__/* .createModeControl */ .Ys)({
  summaryValue: 'focused'
})), {}, {
  scrollIndex: {
    control: {
      ...
      value: function _template() {
        return {
          Row: {
            ...
            w: (0,_utils__WEBPACK_IMPORTED_MODULE_4__/* .getWidthByUpCount */ .OO)(_globals__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z.theme, 1),
            items: createItems(_Button__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, 12),
            waitForDimensions: args.waitForDimensions
          }
        };
      }
      ...
      value: function _template() {
        return {
          Row: {
            type: ___WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z,
            w: (0,_utils__WEBPACK_IMPORTED_MODULE_4__/* .getWidthByUpCount */ .OO)(_globals__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z.theme, 1),
            items: createItems(_Button__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, 10, {
              fixed: true,
              w: 200 + Math.floor(Math.random() * 100)
            })
          }
      ...
      value: function _template() {
        return {
          Row: {
            ...
            w: (0,_utils__WEBPACK_IMPORTED_MODULE_4__/* .getWidthByUpCount */ .OO)(_globals__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z.theme, 1),
            items: [{
              type: _Column__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z,
              autoResizeWidth: true,
              autoResizeHeight: true,
              items: createItems(_Button__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, 3)
            }, {
              type: _Column__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z,
              autoResizeWidth: true,
              autoResizeHeight: true,
              centerInParent: true,
              items: createItems(_Button__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, 1)
            }]
          }
        };
      }
...
var Plinko = function Plinko() {
  return /*#__PURE__*/function (_lng$Component7) {
    ...
    _createClass(Plinko, null, [{
      key: "_template",
      value: function _template() {
        var skipFocusButtons = createItems(_Button__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, 3);
        skipFocusButtons[1].skipFocus = true;
        skipFocusButtons[1].title = 'Skip Focus';
        return {
          Row: {
        ...
        return {
          Row: {
            ...
            items: [].concat(_toConsumableArray(Array.apply(null, {
              ...
              return {
                type: _Button__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z,
                title: 'Button'
              };
            })), [{
              type: Title,
      ...
      value: function _template() {
        return {
          Row: {
            ...
            items: [].concat(_toConsumableArray(createItems(_Button__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, 2)), [{
              type: _docs_story_components__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z,
              title: 'Press Enter on this button to remove it (removeItemAt)',
              signalName: 'removeAt',
              passSignals: {
...
Row.parameters = _objectSpread(_objectSpread({}, Row.parameters), {}, {
  docs: _objectSpread(_objectSpread({}, (_Row$parameters = Row.parameters) === null || _Row$parameters === void 0 ? void 0 : _Row$parameters.docs), {}, {
    ...
    description: _objectSpread({
      story: "Stories for various versions of the component"
    }, (_Row$parameters3 = Row.parameters) === null || _Row$parameters3 === void 0 || (_Row$parameters3 = _Row$parameters3.docs) === null || _Row$parameters3 === void 0 ? void 0 : _Row$parameters3.description)
  })
});
FocusHeightChange.parameters = _objectSpread(_objectSpread({}, FocusHeightChange.parameters), {}, {
  docs: _objectSpread(_objectSpread({}, (_FocusHeightChange$pa = FocusHeightChange.parameters) === null || _FocusHeightChange$pa === void 0 ? void 0 : _FocusHeightChange$pa.docs), {}, {
    source: _objectSpread({
      originalSource: "() => class FocusHeightChange extends lng.Component {\n  static _template() {\n    return {\n      Row: {\n        type: RowComponent,\n        w: getWidthByUpCount(context.theme, 1),\n        items: Array.apply(null, {\n          length: 5\n        }).map(() => ({\n          type: ExpandingHeightButton,\n          title: 'Button',\n          w: 150,\n          h: 75\n        }))\n      }\n    };\n  }\n}"
    }, (_FocusHeightChange$pa2 = FocusHeightChange.parameters) === null || _FocusHeightChange$pa2 === void 0 || (_FocusHeightChange$pa2 = _FocusHeightChange$pa2.docs) === null || _FocusHeightChange$pa2 === void 0 ? void 0 : _FocusHeightChange$pa2.source)
  })
});
VaryingItemWidth.parameters = _objectSpread(_objectSpread({}, VaryingItemWidth.parameters), {}, {
  docs: _objectSpread(_objectSpread({}, (_VaryingItemWidth$par = VaryingItemWidth.parameters) === null || _VaryingItemWidth$par === void 0 ? void 0 : _VaryingItemWidth$par.docs), {}, {
    source: _objectSpread({
      originalSource: "() => class VaryingItemWidth extends lng.Component {\n  static _template() {\n    return {\n      Row: {\n        type: RowComponent,\n        w: getWidthByUpCount(context.theme, 1),\n        items: createItems(Button, 10, {\n          fixed: true,\n          w: 200 + Math.floor(Math.random() * 100)\n        })\n      }\n    };\n  }\n}"
    }, (_VaryingItemWidth$par2 = VaryingItemWidth.parameters) === null || _VaryingItemWidth$par2 === void 0 || (_VaryingItemWidth$par2 = _VaryingItemWidth$par2.docs) === null || _VaryingItemWidth$par2 === void 0 ? void 0 : _VaryingItemWidth$par2.source)
  })
});
ExpandableWidth.parameters = _objectSpread(_objectSpread({}, ExpandableWidth.parameters), {}, {
  docs: _objectSpread(_objectSpread({}, (_ExpandableWidth$para = ExpandableWidth.parameters) === null || _ExpandableWidth$para === void 0 ? void 0 : _ExpandableWidth$para.docs), {}, {
    source: _objectSpread({
      originalSource: "() => class ExpandableWidth extends lng.Component {\n  static _template() {\n    return {\n      Row: {\n        type: RowComponent,\n        w: getWidthByUpCount(context.theme, 1),\n        items: createItems(ExpandingButton, 6)\n      }\n    };\n  }\n}"
    }, (_ExpandableWidth$para2 = ExpandableWidth.parameters) === null || _ExpandableWidth$para2 === void 0 || (_ExpandableWidth$para2 = _ExpandableWidth$para2.docs) === null || _ExpandableWidth$para2 === void 0 ? void 0 : _ExpandableWidth$para2.source)
  })
});
...
LazyScrollIndexes.parameters = _objectSpread(_objectSpread({}, LazyScrollIndexes.parameters), {}, {
  docs: _objectSpread(_objectSpread({}, (_LazyScrollIndexes$pa = LazyScrollIndexes.parameters) === null || _LazyScrollIndexes$pa === void 0 ? void 0 : _LazyScrollIndexes$pa.docs), {}, {
    source: _objectSpread({
      originalSource: "({\n  startLazyScrollIndex,\n  stopLazyScrollIndex,\n  waitForDimensions\n}) => class LazyScrollIndexes extends lng.Component {\n  static _template() {\n    return {\n      Row: {\n        type: RowComponent,\n        w: getWidthByUpCount(context.theme, 1),\n        items: Array.apply(null, {\n          length: 12\n        }).map((_, i) => ({\n          type: Button,\n          title: `Button ${i + 1} ${i === startLazyScrollIndex ? '(start lazy scroll)' : ''} ${i === stopLazyScrollIndex ? '(stop lazy scroll)' : ''}`\n        })),\n        startLazyScrollIndex,\n        stopLazyScrollIndex,\n        waitForDimensions: waitForDimensions\n      }\n    };\n  }\n}"
    }, (_LazyScrollIndexes$pa2 = LazyScrollIndexes.parameters) === null || _LazyScrollIndexes$pa2 === void 0 || (_LazyScrollIndexes$pa2 = _LazyScrollIndexes$pa2.docs) === null || _LazyScrollIndexes$pa2 === void 0 ? void 0 : _LazyScrollIndexes$pa2.source)
  })
});
...
var __namedExportsOrder = ["Row", "FocusHeightChange", "VaryingItemWidth", "ExpandableWidth", "CenteredInParent", "Plinko", "SkipFocus", "LazyScrollIndexes", "AddingItems", "LazyUpCount", "RemovingItems"];
...
//# sourceMappingURL=6179.f81bac4f.iframe.bundle.js.map