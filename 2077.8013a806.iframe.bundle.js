  ...
  _createClass(Toggle, [{
    ...
    value: function _updateContainer() {
      ...
      this._Container.patch({
        ...
        texture: lightning_esm/* default */.Z.Tools.getRoundRect(
        // Compensating for the extra 2 pixels getRoundRect adds
        this.w - strokeWidth * 2 - 2, this.h - strokeWidth * 2 - 2, (0,utils/* getMaxRoundRadius */.JS)(radius, this.w, this.h), strokeWidth, 0, true, false)
      });
    }
  }, {
    key: "_updateStroke",
    value: function _updateStroke() {
      ...
      this._Stroke.patch({
        ...
        texture: lightning_esm/* default */.Z.Tools.getRoundRect(
        // Compensating for the extra 2 pixels getRoundRect adds
        this.w - 2, this.h - 2, strokeRadius !== undefined ? (0,utils/* getMaxRoundRadius */.JS)(strokeRadius, this.w, this.h) : (0,utils/* getMaxRoundRadius */.JS)(knobRadius, this.w - knobPadding * 2 - 2, this.h - knobPadding * 2 - 2) + knobPadding + strokeWidth, strokeWidth, strokeColor, false, false)
      });
    }
  }, {
    key: "_updateKnob",
    value: function _updateKnob() {
      ...
      this._Knob.patch({
        ...
        texture: lightning_esm/* default */.Z.Tools.getRoundRect(
        // Compensating for the extra 2 pixels getRoundRect adds
        knobWidth - 2, knobHeight - 2, (0,utils/* getMaxRoundRadius */.JS)(knobRadius, knobWidth - 2, knobHeight - 2), 0, 0, true, false)
      });
    }
  }, {
    key: "_setChecked",
...
//# sourceMappingURL=2077.8013a806.iframe.bundle.js.map