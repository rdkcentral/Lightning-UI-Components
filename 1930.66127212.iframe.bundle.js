"use strict";
(self["webpackChunklightning_ui_docs"] = self["webpackChunklightning_ui_docs"] || []).push([[1930],{
...
var Artwork = /*#__PURE__*/function (_Base) {
  function Artwork() {
    ...
    return _callSuper(this, Artwork, arguments);
  }
  ...
  return _createClass(Artwork, [{
    ...
    key: "w",
    get: function get() {
      return _superPropGet(Artwork, "w", this, 1);
    },
    set: function set(v) {
      if (v === _superPropGet(Artwork, "w", this, 1)) return;
      _superPropSet(Artwork, "w", v, this, 1, 1);
      this._componentSrc = this._generatePromise();
    }
  }, {
    key: "h",
    get: function get() {
      return _superPropGet(Artwork, "h", this, 1);
    },
    set: function set(v) {
      if (v === _superPropGet(Artwork, "h", this, 1)) return;
      _superPropSet(Artwork, "h", v, this, 1, 1);
      this._componentSrc = this._generatePromise();
    }
  }, {
    ...
    get: function get() {
      ...
      return (0,utils/* reduceFraction */.Hd)("".concat(this.w, "/").concat(this.h)).replace('/', 'x');
    }
  }, {
    ...
    get: function get() {
      return {
        ...
        style: {
          gradientColor: (0,utils/* getValidColor */.MG)(this.style.gradientColor)
        },
        h: this.h + 4,
        type: Gradient/* default */.A,
        w: this.w + 4,
        x: -2,
        y: -2,
    ...
    value: function _construct() {
      _superPropGet(Artwork, "_construct", this, 3)([]);
    ...
    value: function _handleImageLoadError() {
      ...
      context/* default */.A.error("Image ".concat(this._src, " failed to load"));
      ...
      if (!this._srcFailed && this._shouldBlur) {
        this.patch({
          Blur: {
            ...
            h: this.h,
            rtt: true,
            type: lightning_esm/* default */.A.components.FastBlurComponent,
            w: this.w
          }
        });
    ...
    value: function _updateRadius() {
      ...
      this.patch(this.style.radius ? {
        shader: {
          type: lightning_esm/* default */.A.shaders.RoundedRectangle,
          radius: (0,utils/* getMaxRoundRadius */.XG)(this.style.radius, this.w, this.h)
        }
      } : {
        shader: undefined
      });
...
//# sourceMappingURL=1930.66127212.iframe.bundle.js.map