(self["webpackChunklightning_ui_docs"] = self["webpackChunklightning_ui_docs"] || []).push([[2555,3597],{
  ...
  return /*#__PURE__*/function (_Base) {
    ...
    return _createClass(_class, [{
      ...
      value: function _swapItemArrayPos(array, current, previous) {
        ...
        _superPropSet(_class, "selectedIndex", current, this, 1, 1);
      }
    }, {
      key: "_getPositionValue",
      value: function _getPositionValue(item, axis) {
        return item.transition(axis) ? item.transition(axis).targetValue : item[axis];
      }
    }, {
      key: "_waitForTransition",
      value: function _waitForTransition(item, axis) {
        return new Promise(function (resolve) {
          return item._getTransition(axis).on('finish', resolve);
        });
      }
      ...
      key: "selectedIndex",
      get: function get() {
        return _superPropGet(_class, "selectedIndex", this, 1);
      },
      set: function set(index) {
        var _this = this;
        if (!this.isEditing || this.selectedIndex >= this.items.length - 1 && index > this.selectedIndex) {
          if (!this.isEditing) {
            _superPropSet(_class, "selectedIndex", index, this, 1, 1);
          }
          return;
        }
        ...
        _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          var _this$Items$children$;
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return Promise.all([_this._waitForTransition(currentItem, 'x'), _this._waitForTransition(currentItem, 'y'), _this._waitForTransition(nextItem, 'x'), _this._waitForTransition(nextItem, 'y')]);
              case 2:
                currentItem.zIndex = previousCurrentItemZIndex; // Reset zIndex

                if (!_this.Items.children.length || !((_this$Items$children$ = _this.Items.children[index]) !== null && _this$Items$children$ !== void 0 && _this$Items$children$.skipFocus)) {
...
const withEditItems = () => class withEditItems extends lightning_esm/* default */.A.Component {
  static _template() {
    return {
      RowComponent: {
...
//# sourceMappingURL=mixins-withEditItems-withEditItems-mdx.27fb3298.iframe.bundle.js.map