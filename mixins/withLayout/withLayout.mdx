...
If the mixin is unable to calculate the height OR width from the passed parameters. The height will default 9/16 of the width. Inversly the width will default to 16/9 of the height.
