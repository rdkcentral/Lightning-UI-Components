...
Note: The `SpeechSynthesis` API has some known problems:
- [Problems with the cancel() method](https://stackoverflow.com/questions/39391502/js-speechsynthesis-problems-with-the-cancel-method)
- [onend callback not working](https://stackoverflow.com/questions/23483990/speechsynthesis-api-onend-callback-not-working)

This class does its best to work around these issues, but the `SpeechSynthesis` API can randomly fail.
...
```js
import { Announcer } from '@lightningjs/ui-components-components'
