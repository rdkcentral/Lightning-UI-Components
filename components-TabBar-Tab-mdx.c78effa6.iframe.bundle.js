(self["webpackChunklightning_ui_docs"] = self["webpackChunklightning_ui_docs"] || []).push([[4996,46],{
...
const Tab = () => class Tab extends _lightningjs_core__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.Component {
  static _template() {
    return {
      Tab: {
        type: _Tab__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A
      }
    };
  }
};
...
Tab.parameters = {
  argActions: {
    icon: (icon, component) => {
      component.tag('Tab').icon = icon ? _assets_images_ic_lightning_white_32_png__WEBPACK_IMPORTED_MODULE_3__ : undefined;
    }
  }
};
;
...
//# sourceMappingURL=components-TabBar-Tab-mdx.c78effa6.iframe.bundle.js.map