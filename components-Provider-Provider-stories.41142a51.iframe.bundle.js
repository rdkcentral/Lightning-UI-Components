  ...
  _createClass(Provider, [{
    ...
    value: function _updateProviders() {
      ...
      this.providers.slice(0, this.visibleCount).forEach(function (provider) {
        ...
        var patch = {
          centerInParent: true,
          radius: _this.disableRadius ? 0 : (0,utils/* getMaxRoundRadius */.JS)(_this.style.radius, _this.style.itemSize, _this.style.itemSize),
      ...
      if (this.providers.length > this.visibleCount) {
        ...
        var counter = {
          ...
          Background: {
            w: this.style.itemSize,
            h: this.style.itemSize,
            texture: lightning_esm/* default */.Z.Tools.getRoundRect(this.style.itemSize, this.style.itemSize, (0,utils/* getMaxRoundRadius */.JS)(this.style.radius, this.style.itemSize, this.style.itemSize), 0, null, true, this.style.counterBackgroundColor)
          },
          Text: {
...
//# sourceMappingURL=components-Provider-Provider-stories.41142a51.iframe.bundle.js.map