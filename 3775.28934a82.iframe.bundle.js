"use strict";
(self["webpackChunklightning_ui_docs"] = self["webpackChunklightning_ui_docs"] || []).push([[3775],{
      ...
      this.patch({
        Frame: {
          ...
          Shadow: {
            ...
            this.w + this.style.spread * 2, this.h + this.style.spread * 2, this.style.radius, this.style.blur)
          }
        }
      });
...
function Shadow_stories_typeof(o) { "@babel/helpers - typeof"; return Shadow_stories_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, Shadow_stories_typeof(o); }
var _Shadow$parameters, _Shadow$parameters2;
function ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function _defineProperty(obj, key, value) { key = Shadow_stories_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function Shadow_stories_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function Shadow_stories_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, Shadow_stories_toPropertyKey(descriptor.key), descriptor); } }
function Shadow_stories_createClass(Constructor, protoProps, staticProps) { if (protoProps) Shadow_stories_defineProperties(Constructor.prototype, protoProps); if (staticProps) Shadow_stories_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function Shadow_stories_toPropertyKey(arg) { var key = Shadow_stories_toPrimitive(arg, "string"); return Shadow_stories_typeof(key) === "symbol" ? key : String(key); }
function Shadow_stories_toPrimitive(input, hint) { if (Shadow_stories_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (Shadow_stories_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function Shadow_stories_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) Shadow_stories_setPrototypeOf(subClass, superClass); }
function Shadow_stories_setPrototypeOf(o, p) { Shadow_stories_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return Shadow_stories_setPrototypeOf(o, p); }
function Shadow_stories_createSuper(Derived) { var hasNativeReflectConstruct = Shadow_stories_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = Shadow_stories_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = Shadow_stories_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return Shadow_stories_possibleConstructorReturn(this, result); }; }
function Shadow_stories_possibleConstructorReturn(self, call) { if (call && (Shadow_stories_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return Shadow_stories_assertThisInitialized(self); }
function Shadow_stories_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
function Shadow_stories_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function Shadow_stories_getPrototypeOf(o) { Shadow_stories_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return Shadow_stories_getPrototypeOf(o); }
/* eslint-disable */
// @ts-nocheck
...
Shadow.argTypes = _objectSpread(_objectSpread({}, (0,utils/* createModeControl */.Ys)({
  summaryValue: 'focused'
})), {}, {
  maskShadow: {
    control: 'boolean',
...
Shadow.parameters = _objectSpread(_objectSpread({}, Shadow.parameters), {}, {
  docs: _objectSpread(_objectSpread({}, (_Shadow$parameters = Shadow.parameters) === null || _Shadow$parameters === void 0 ? void 0 : _Shadow$parameters.docs), {}, {
    source: _objectSpread({
      originalSource: "() => class Shadow extends lng.Component {\n  static _template() {\n    return {\n      Shadow: {\n        type: ShadowComponent,\n        w: 200,\n        h: 200\n      }\n    };\n  }\n}"
    }, (_Shadow$parameters2 = Shadow.parameters) === null || _Shadow$parameters2 === void 0 || (_Shadow$parameters2 = _Shadow$parameters2.docs) === null || _Shadow$parameters2 === void 0 ? void 0 : _Shadow$parameters2.source)
  })
});
var __namedExportsOrder = ["Shadow"];
...
//# sourceMappingURL=3775.28934a82.iframe.bundle.js.map