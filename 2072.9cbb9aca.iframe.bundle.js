"use strict";
(self["webpackChunklightning_ui_docs"] = self["webpackChunklightning_ui_docs"] || []).push([[2072],{
...
var Artwork = /*#__PURE__*/function (_Base) {
  ...
  _createClass(Artwork, [{
    ...
    set: function set(v) {
      if (v === _get(_getPrototypeOf(Artwork.prototype), "w", this)) return;
    ...
    set: function set(v) {
      if (v === _get(_getPrototypeOf(Artwork.prototype), "h", this)) return;
...
//# sourceMappingURL=2072.9cbb9aca.iframe.bundle.js.map