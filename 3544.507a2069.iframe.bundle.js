"use strict";
(self["webpackChunklightning_ui_docs"] = self["webpackChunklightning_ui_docs"] || []).push([[3544],{
  ...
  _createClass(Artwork, [{
    ...
    value: function _updateRadius() {
      ...
      this.patch(this.style.radius ? {
        shader: {
          type: lightning_esm/* default */.Z.shaders.RoundedRectangle,
          radius: (0,utils/* getMaxRoundRadius */.JS)(this.style.radius, this.w, this.h)
        }
      } : {
        shader: undefined
      });
  ...
  _createClass(Gradient, [{
    ...
    value: function _update() {
      this.patch({
        ...
        texture: lightning_esm/* default */.Z.Tools.getRoundRect(this.w, this.h, (0,utils/* getMaxRoundRadius */.JS)(this.style.radius, this.w, this.h))
      });
    }
  }], [{
    key: "__componentName",
