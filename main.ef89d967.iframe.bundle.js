(self["webpackChunklightning_ui_docs"] = self["webpackChunklightning_ui_docs"] || []).push([[8792],{
...
function _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, Badge_toPropertyKey(o.key), o); } }
function _createClass(e, r, t) { return r && _defineProperties(e.prototype, r), t && _defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function _callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, _isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
function _possibleConstructorReturn(t, e) { if (e && ("object" == Badge_typeof(e) || "function" == typeof e)) return e; if (void 0 !== e) throw new TypeError("Derived constructors may only return object or undefined"); return _assertThisInitialized(t); }
...
function set(e, r, t, o) { return set = "undefined" != typeof Reflect && Reflect.set ? Reflect.set : function (e, r, t, o) { var f, i = _superPropBase(e, r); if (i) { if ((f = Object.getOwnPropertyDescriptor(i, r)).set) return f.set.call(o, t), !0; if (!f.writable) return !1; } if (f = Object.getOwnPropertyDescriptor(o, r)) { if (!f.writable) return !1; f.value = t, Object.defineProperty(o, r, f); } else Badge_defineProperty(o, r, t); return !0; }, set(e, r, t, o); }
...
var Badge = /*#__PURE__*/function (_Base) {
  ...
  return _createClass(Badge, [{
    ...
    value: function _init() {
      ...
      _superPropGet(Badge, "_init", this, 3)([]);
    }
  }, {
    key: "_update",
    ...
    value: function _updateBackground() {
      ...
      this.patch({
        h: height,
        texture: lightning_esm/* default */.A.Tools.getRoundRect(this.w, height, (0,utils/* getMaxRoundRadius */.XG)(this.style.radius, this.w, height), this.style.strokeWidth, this.style.strokeColor, true, this.style.backgroundColor)
      });
    }
  }, {
    key: "_updateText",
    ...
    value: function _updateIcon() {
      this._Icon.patch({
        ...
        h: this.iconHeight,
        style: {
          color: (0,utils/* getHexColor */.H2)(this.style.iconColor)
        }
      });
    }
  }, {
    ...
    set: function set(announce) {
      _superPropSet(Badge, "announce", announce, this, 1, 1);
    }
  }], [{
    key: "_template",
  ...
  return /*#__PURE__*/function (_Base) {
    ...
    return _createClass(_class, [{
      ...
      value: function _construct() {
        _superPropGet(_class, "_construct", this, 1) && _superPropGet(_class, "_construct", this, 3)([]);
      ...
      set: function set(v) {
        ...
        if (v) {
          itemLayout = JSON.parse(JSON.stringify(v, function (k, v) {
            if (k !== 'circle' && v < 0) {
              context/* default */.A.error("itemLayout for ".concat(componentName, " received an invalid value of ").concat(v, " for ").concat(k));
              return;
            } else if (k === 'circle') {
              return Boolean(v);
            }
        ...
        if (!(0,utils/* stringifyCompare */.du)(this._itemLayout, itemLayout)) {
      ...
      value: function _allowUpdate() {
        ...
        var layoutString = Object.values(context/* default */.A.theme.layout).join('') + "".concat(w).concat(h).concat(circle ? 1 : 0).concat(ratioX).concat(ratioY).concat(upCount);
      ...
      value: function _updateItemLayout() {
        ...
        var _getDimensions = (0,utils/* getDimensions */.Eo)(this.theme, this._itemLayout),
          w = _getDimensions.w,
          h = _getDimensions.h;
        if (h || w) {
          // If there is not enough information passed in args to calculate item size
          var width = context/* default */.A.theme.layout.screenW;
          var height = context/* default */.A.theme.layout.screenH;
...
function withExtensions_typeof(o) { "@babel/helpers - typeof"; return withExtensions_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, withExtensions_typeof(o); }
function withExtensions_classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function withExtensions_defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, withExtensions_toPropertyKey(o.key), o); } }
function withExtensions_createClass(e, r, t) { return r && withExtensions_defineProperties(e.prototype, r), t && withExtensions_defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function withExtensions_toPropertyKey(t) { var i = withExtensions_toPrimitive(t, "string"); return "symbol" == withExtensions_typeof(i) ? i : i + ""; }
function withExtensions_toPrimitive(t, r) { if ("object" != withExtensions_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != withExtensions_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
function withExtensions_callSuper(t, o, e) { return o = withExtensions_getPrototypeOf(o), withExtensions_possibleConstructorReturn(t, withExtensions_isNativeReflectConstruct() ? Reflect.construct(o, e || [], withExtensions_getPrototypeOf(t).constructor) : o.apply(t, e)); }
function withExtensions_possibleConstructorReturn(t, e) { if (e && ("object" == withExtensions_typeof(e) || "function" == typeof e)) return e; if (void 0 !== e) throw new TypeError("Derived constructors may only return object or undefined"); return withExtensions_assertThisInitialized(t); }
function withExtensions_assertThisInitialized(e) { if (void 0 === e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); return e; }
function withExtensions_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (withExtensions_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
function withExtensions_superPropGet(t, e, o, r) { var p = withExtensions_get(withExtensions_getPrototypeOf(1 & r ? t.prototype : t), e, o); return 2 & r && "function" == typeof p ? function (t) { return p.apply(o, t); } : p; }
function withExtensions_get() { return withExtensions_get = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function (e, t, r) { var p = withExtensions_superPropBase(e, t); if (p) { var n = Object.getOwnPropertyDescriptor(p, t); return n.get ? n.get.call(arguments.length < 3 ? e : r) : n.value; } }, withExtensions_get.apply(null, arguments); }
function withExtensions_superPropBase(t, o) { for (; !{}.hasOwnProperty.call(t, o) && null !== (t = withExtensions_getPrototypeOf(t));); return t; }
function withExtensions_getPrototypeOf(t) { return withExtensions_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function (t) { return t.__proto__ || Object.getPrototypeOf(t); }, withExtensions_getPrototypeOf(t); }
function withExtensions_inherits(t, e) { if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function"); t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } }), Object.defineProperty(t, "prototype", { writable: !1 }), e && withExtensions_setPrototypeOf(t, e); }
function withExtensions_setPrototypeOf(t, e) { return withExtensions_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function (t, e) { return t.__proto__ = e, t; }, withExtensions_setPrototypeOf(t, e); }
/**
 * Copyright 2023 Comcast Cable Communications Management, LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
function withExtensions(Base) {
  ...
  return /*#__PURE__*/function (_Base) {
    function _class() {
      withExtensions_classCallCheck(this, _class);
      return withExtensions_callSuper(this, _class, arguments);
    }
    withExtensions_inherits(_class, _Base);
    return withExtensions_createClass(_class, [{
      key: "_prototypeChain",
      get:
      /**
      ...
      function get() {
        ...
        do {
          ...
          if (null !== proto && withExtensions_typeof(proto) === 'object') {
            try {
      ...
      key: "_extensions",
      get: function get() {
        var extensions = context/* default */.A && context/* default */.A.theme && context/* default */.A.theme.extensions;
      ...
      value: function _construct() {
        ...
        context/* default */.A.on('themeUpdate', this._setupExtensionBound);
        this._currentComponentExtensionLength = this._calculateComponentExtensionLength();
        this._createExtension();
        withExtensions_superPropGet(_class, "_construct", this, 3)([]);
      }
    }, {
      key: "_detach",
      value: function _detach() {
        withExtensions_superPropGet(_class, "_detach", this, 3)([]);
        context/* default */.A.off('themeUpdate', this._setupExtensionBound);
      }
    }, {
      key: "_setupExtension",
      ...
      value: function _createExtensionAliases(obj) {
        ...
        var extensionOverrides = this._componentExtensions.reduce(function (acc, extension) {
          var extensionClass = new extension(/*#__PURE__*/withExtensions_createClass(function FakeClass() {
            withExtensions_classCallCheck(this, FakeClass);
          }));
      ...
      key: "__componentName",
      get: function get() {
        if (!withExtensions_superPropGet(_class, "__componentName", this)) {
        ...
        return withExtensions_superPropGet(_class, "__componentName", this);
      }
    }, {
...
function Base_callSuper(t, o, e) { return o = Base_getPrototypeOf(o), Base_possibleConstructorReturn(t, Base_isNativeReflectConstruct() ? Reflect.construct(o, e || [], Base_getPrototypeOf(t).constructor) : o.apply(t, e)); }
function Base_possibleConstructorReturn(t, e) { if (e && ("object" == Base_typeof(e) || "function" == typeof e)) return e; if (void 0 !== e) throw new TypeError("Derived constructors may only return object or undefined"); return Base_assertThisInitialized(t); }
function Base_assertThisInitialized(e) { if (void 0 === e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); return e; }
function Base_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (Base_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
function Base_getPrototypeOf(t) { return Base_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function (t) { return t.__proto__ || Object.getPrototypeOf(t); }, Base_getPrototypeOf(t); }
function Base_inherits(t, e) { if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function"); t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } }), Object.defineProperty(t, "prototype", { writable: !1 }), e && Base_setPrototypeOf(t, e); }
function Base_setPrototypeOf(t, e) { return Base_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function (t, e) { return t.__proto__ = e, t; }, Base_setPrototypeOf(t, e); }
/**
 * Copyright 2023 Comcast Cable Communications Management, LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
var Base = /*#__PURE__*/function (_lng$Component) {
  function Base() {
    ...
    return Base_callSuper(this, Base, arguments);
  }
  ...
  return Base_createClass(Base, [{
    ...
    value: function isFullyOnScreen(offsets) {
      return (0,utils/* isComponentOnScreen */.Ny)(this, offsets);
    }
  }, {
    key: "getFocusScale",
    value: function getFocusScale() {
      return context/* default */.A.theme.layout.focusScale;
    }
  }, {
    key: "getUnfocusScale",
...
function withMixins(baseComponent) {
  return withExtensions(withLayout((0,withThemeStyles/* default */.A)((0,withUpdates/* default */.A)((0,withTags/* default */.A)((0,withHandleKey/* default */.A)(baseComponent))))));
}
...
function Column_defineProperty(e, r, t) { return (r = Column_toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, Column_toPropertyKey(o.key), o); } }
function _createClass(e, r, t) { return r && _defineProperties(e.prototype, r), t && _defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
...
function _callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, _isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
function _possibleConstructorReturn(t, e) { if (e && ("object" == Column_typeof(e) || "function" == typeof e)) return e; if (void 0 !== e) throw new TypeError("Derived constructors may only return object or undefined"); return _assertThisInitialized(t); }
function _assertThisInitialized(e) { if (void 0 === e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); return e; }
function _isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
function _superPropGet(t, e, o, r) { var p = _get(_getPrototypeOf(1 & r ? t.prototype : t), e, o); return 2 & r && "function" == typeof p ? function (t) { return p.apply(o, t); } : p; }
function _get() { return _get = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function (e, t, r) { var p = _superPropBase(e, t); if (p) { var n = Object.getOwnPropertyDescriptor(p, t); return n.get ? n.get.call(arguments.length < 3 ? e : r) : n.value; } }, _get.apply(null, arguments); }
...
var Column = /*#__PURE__*/function (_NavigationManager) {
  ...
  return _createClass(Column, [{
    ...
    key: "_itemsY",
    get: function get() {
      return (0,utils/* getY */.s6)(this.Items);
    }
  }, {
    key: "$removeItem",
    ...
    key: "_template",
    value: function _template() {
      return Column_objectSpread(Column_objectSpread({}, _superPropGet(Column, "_template", this, 2)([])), {}, {
        direction: 'column'
      });
    }
  }]);
}(NavigationManager/* default */.A);
...
/* harmony export */   A: () => (/* binding */ FocusManager)
/* harmony export */ });
...
var FocusManager = /*#__PURE__*/function (_Base) {
  function FocusManager() {
    ...
    return _callSuper(this, FocusManager, arguments);
  }
  _inherits(FocusManager, _Base);
  return _createClass(FocusManager, [{
    key: "_construct",
    value: function _construct() {
      _superPropGet(FocusManager, "_construct", this, 3)([]);
    ...
    value: function _getIndexOfItemNear(selected, prev) {
      ...
      var selectedCoordArray = selected.items.map(function (item, index) {
        return {
          index: index,
          distance: !item.skipFocus ? (0,_utils__WEBPACK_IMPORTED_MODULE_0__/* .getShortestDistance */ .IG)(prevMiddle, item) : null
        };
    ...
    key: "_focus",
    value: function _focus() {
      _superPropGet(FocusManager, "_focus", this, 3)([]);
    ...
    key: "_unfocus",
    value: function _unfocus() {
      _superPropGet(FocusManager, "_unfocus", this, 3)([]);
      this.items.forEach(function (item) {
    ...
    value: function _isOnScreenCompletely(child) {
      ...
      return child.isFullyOnScreen ? child.isFullyOnScreen() : (0,_utils__WEBPACK_IMPORTED_MODULE_0__/* .isComponentOnScreen */ .Ny)(child);
    }
  }, {
    ...
    value: function _isComponentHorizontallyVisible(child) {
      ...
      var x = (0,_utils__WEBPACK_IMPORTED_MODULE_0__/* .getX */ .ls)(child);
    ...
    value: function _isComponentVerticallyVisible(child) {
      ...
      // get the value of where child will end up
      var y = (0,_utils__WEBPACK_IMPORTED_MODULE_0__/* .getY */ .s6)(child);
      if (!Number.isFinite(y)) return false;
...
}(_Base__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A);
...
function GridOverlay_defineProperty(e, r, t) { return (r = GridOverlay_toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, GridOverlay_toPropertyKey(o.key), o); } }
function _createClass(e, r, t) { return r && _defineProperties(e.prototype, r), t && _defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function GridOverlay_toPropertyKey(t) { var i = GridOverlay_toPrimitive(t, "string"); return "symbol" == GridOverlay_typeof(i) ? i : i + ""; }
...
function _callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, _isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
function _possibleConstructorReturn(t, e) { if (e && ("object" == GridOverlay_typeof(e) || "function" == typeof e)) return e; if (void 0 !== e) throw new TypeError("Derived constructors may only return object or undefined"); return _assertThisInitialized(t); }
function _assertThisInitialized(e) { if (void 0 === e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); return e; }
function _isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
function _getPrototypeOf(t) { return _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function (t) { return t.__proto__ || Object.getPrototypeOf(t); }, _getPrototypeOf(t); }
function _inherits(t, e) { if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function"); t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } }), Object.defineProperty(t, "prototype", { writable: !1 }), e && _setPrototypeOf(t, e); }
...
var Spacer = /*#__PURE__*/function (_Base) {
  function Spacer() {
    ...
    return _callSuper(this, Spacer, arguments);
  }
...
var GridOverlay = /*#__PURE__*/function (_Base2) {
  function GridOverlay() {
    ...
    return _callSuper(this, GridOverlay, arguments);
  }
  _inherits(GridOverlay, _Base2);
  return _createClass(GridOverlay, [{
    key: "_construct",
    value: function _construct() {
      _superPropGet(GridOverlay, "_construct", this, 3)([]);
    ...
    value: function _updateGlobalThemeProps() {
      var _context$theme = context/* default */.A.theme,
    ...
    get: function get() {
      ...
      return Array.apply(null, {
        ...
        return {
          rect: true,
          w: (0,utils/* getWidthByColumnSpan */._l)(_this.theme, 1),
          h: _this._screenH,
    ...
    value: function _updateText() {
      var prop = 'Property';
      var val = 'Value';
      this._TextPanel.x = this._screenW - this._marginX - (0,utils/* getWidthByColumnSpan */._l)(this.theme, 3);
      ...
      this._TextColumnCount.Items.tag(val).content = "".concat(this._columnCount, ", ").concat(Math.round((0,utils/* getWidthByColumnSpan */._l)(this.theme, 1)), "px each");
...
var Icon = /*#__PURE__*/function (_Base) {
  ...
  return _createClass(Icon, [{
    ...
    value: function _handleTxtError() {
      context/* default */.A.error("Unable to load icon ".concat(this._icon));
      this._icon = null;
      this.texture = null;
    }
    ...
    get: function get() {
      ...
      if (svgTag) {
        texture = lightning_esm/* default */.A.Tools.getSvgTexture("data:image/svg+xml,".concat(encodeURIComponent(this.icon)), this.w, this.h);
      } else if (svgURI) {
        texture = lightning_esm/* default */.A.Tools.getSvgTexture(this.icon, this.w, this.h);
      } else {
        texture = {
          type: CustomImageTexture/* default */.A,
          w: this.w,
          h: this.h,
          src: this.icon
        };
      }
      var color = (0,utils/* getValidColor */.MG)(this._color || this.style.color);
...
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, InlineContent_toPropertyKey(o.key), o); } }
function _createClass(e, r, t) { return r && _defineProperties(e.prototype, r), t && _defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function _callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, _isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
function _possibleConstructorReturn(t, e) { if (e && ("object" == InlineContent_typeof(e) || "function" == typeof e)) return e; if (void 0 !== e) throw new TypeError("Derived constructors may only return object or undefined"); return _assertThisInitialized(t); }
function _assertThisInitialized(e) { if (void 0 === e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); return e; }
function _isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
function _superPropSet(t, e, o, r, p, f) { return _set(_getPrototypeOf(f ? t.prototype : t), e, o, r, p); }
function set(e, r, t, o) { return set = "undefined" != typeof Reflect && Reflect.set ? Reflect.set : function (e, r, t, o) { var f, i = _superPropBase(e, r); if (i) { if ((f = Object.getOwnPropertyDescriptor(i, r)).set) return f.set.call(o, t), !0; if (!f.writable) return !1; } if (f = Object.getOwnPropertyDescriptor(o, r)) { if (!f.writable) return !1; f.value = t, Object.defineProperty(o, r, f); } else InlineContent_defineProperty(o, r, t); return !0; }, set(e, r, t, o); }
function _set(e, r, t, o, f) { if (!set(e, r, t, o || e) && f) throw new TypeError("failed to set property"); return t; }
function InlineContent_defineProperty(e, r, t) { return (r = InlineContent_toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
function InlineContent_toPropertyKey(t) { var i = InlineContent_toPrimitive(t, "string"); return "symbol" == InlineContent_typeof(i) ? i : i + ""; }
...
var InlineContent = /*#__PURE__*/function (_Base) {
  function InlineContent() {
    ...
    return _callSuper(this, InlineContent, arguments);
  }
  _inherits(InlineContent, _Base);
  return _createClass(InlineContent, [{
    key: "_construct",
    value: function _construct() {
      _superPropGet(InlineContent, "_construct", this, 3)([]);
      ...
      if (this._parsedContent && this._parsedContent.length) {
        ...
        this._parsedContent.forEach(function (item, index) {
          ...
          if (isText(item)) {
            ...
            if (nextItem && isText(nextItem) || _this.contentWrap && nextItem && nextItem.newline && _this._parsedContent[index + 2] && isText(_this._parsedContent[index + 2])) {
    ...
    value: function _calcChildrenDimensions() {
      var _this5 = this;
      var suffixW = (0,utils/* measureTextWidth */.WI)(InlineContent_objectSpread(InlineContent_objectSpread({}, this.style.textStyle), {}, {
    ...
    value: function _createText(base, text) {
      ...
      var textComponent = InlineContent_objectSpread(InlineContent_objectSpread({}, base), {}, {
      ...
      if ((textOverrideStyles === null || textOverrideStyles === void 0 ? void 0 : textOverrideStyles.textDecoration) === 'line-through') {
        var textWidth = (0,utils/* measureTextWidth */.WI)(InlineContent_objectSpread(InlineContent_objectSpread(InlineContent_objectSpread({}, this.style.textStyle), textOverrideStyles), {}, {
          text: text.text || text
        }));
        ...
        return {
          type: lightning_esm/* default */.A.Component,
          w: textWidth + textComponent.flexItem.marginRight,
          h: textComponent.h,
          children: [InlineContent_objectSpread({}, textComponent), InlineContent_objectSpread({}, strikethroughLine)]
        };
      }
    ...
    value: function _formatSpaces(parsedContent) {
      ...
      var whitespace = /(.+?\s+)/;
      return (0,utils/* flatten */.Bq)((parsedContent || []).reduce(function (acc, item) {
        var parsed = item;
        if (isText(item)) {
    ...
    value: function _setContent(content) {
      if (content !== this._content) {
        ...
        if (content && !Array.isArray(content)) {
          parsedContent = (0,utils/* parseInlineContent */.Ym)(content);
        }
    ...
    set: function set(announce) {
      _superPropSet(InlineContent, "announce", announce, this, 1, 1);
    }
  }], [{
    key: "properties",
    get: function get() {
...
var Marquee = /*#__PURE__*/function (_Base) {
  function Marquee() {
    ...
    return _callSuper(this, Marquee, arguments);
  }
  _inherits(Marquee, _Base);
  return _createClass(Marquee, [{
    key: "_construct",
    value: function _construct() {
      _superPropGet(Marquee, "_construct", this, 3)([]);
    ...
    value: function _init() {
      ...
      _superPropGet(Marquee, "_init", this, 3)([]);
    }
  }, {
    ...
    value: function _updateColor() {
      if (this.color) {
        this._Content.smooth = {
          color: utils/* default.getValidColor */.Ay.getValidColor(this.color)
        };
      }
    }
  }, {
    ...
    set: function set(announce) {
      _superPropSet(Marquee, "announce", announce, this, 1, 1);
    }
  }], [{
    key: "_template",
    value: function _template() {
...
var NavigationManager = /*#__PURE__*/function (_FocusManager) {
  function NavigationManager() {
    ...
    return _callSuper(this, NavigationManager, arguments);
  }
  _inherits(NavigationManager, _FocusManager);
  return _createClass(NavigationManager, [{
    key: "_construct",
    value: function _construct() {
      _superPropGet(NavigationManager, "_construct", this, 3)([]);
      this.shouldSmooth = false;
    ...
    value: function _init() {
      ...
      _superPropGet(NavigationManager, "_init", this, 3)([]);
    }
  }, {
    ...
    value: function _updateLayout() {
      ...
      for (var i = 0; i < this.Items.children.length; i++) {
        ...
        maxCrossDimensionSize = (0,utils/* max */.T9)(maxCrossDimensionSize, childCrossDimensionSize);
        maxInnerCrossDimensionSize = (0,utils/* max */.T9)(maxInnerCrossDimensionSize, child[innerCrossDimension] || 0);
      ...
      this.Items.patch(_defineProperty(_defineProperty(_defineProperty({}, crossDimension, maxCrossDimensionSize), innerCrossDimension, maxInnerCrossDimensionSize || maxCrossDimensionSize), lengthDimension, nextPosition + (this._totalAddedWidth || 0)));
      this._autoResize();
    ...
    value: function _calcCrossDimensionSize(comp) {
      if (this._isRow) {
        return (0,utils/* getH */.l6)(comp);
      }
      if (this._isColumn) {
        return (0,utils/* getW */.q)(comp);
      }
    }
  }, {
    ...
    value: function _calcAxisPosition(comp) {
      if (this._isRow) {
        return (0,utils/* getX */.ls)(comp);
      }
      if (this._isColumn) {
        return (0,utils/* getY */.s6)(comp);
      }
    }
  }, {
    ...
    value: function _withAfterUpdate(element) {
      return (0,utils/* watchForUpdates */.p9)({
        element: element,
    ...
    key: "_itemsX",
    get: function get() {
      return (0,utils/* getX */.ls)(this.Items);
    }
  }, {
    key: "_itemsY",
    get: function get() {
    ...
    value: function isFullyOnScreen() {
      ...
      if (focusmanager instanceof FocusManager/* default */.A) {
        offsetX += focusmanager.Items.transition('x').targetValue || 0;
        offsetY += focusmanager.Items.transition('y').targetValue || 0;
      }
      return _superPropGet(NavigationManager, "isFullyOnScreen", this, 3)([{
        offsetX: offsetX,
        offsetY: offsetY
      }]);
    }
    ...
    key: "properties",
    get: function get() {
      return [].concat(_toConsumableArray(_superPropGet(NavigationManager, "properties", this)), ['alwaysScroll', 'neverScroll', 'scrollIndex', 'autoResizeWidth', 'autoResizeHeight', 'lazyUpCount', 'lazyUpCountBuffer', 'waitForDimensions']);
    }
  }]);
}(FocusManager/* default */.A);
...
function Row_defineProperty(e, r, t) { return (r = Row_toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, Row_toPropertyKey(o.key), o); } }
function _createClass(e, r, t) { return r && _defineProperties(e.prototype, r), t && _defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function Row_toPropertyKey(t) { var i = Row_toPrimitive(t, "string"); return "symbol" == Row_typeof(i) ? i : i + ""; }
...
function _callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, _isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
function _possibleConstructorReturn(t, e) { if (e && ("object" == Row_typeof(e) || "function" == typeof e)) return e; if (void 0 !== e) throw new TypeError("Derived constructors may only return object or undefined"); return _assertThisInitialized(t); }
function _assertThisInitialized(e) { if (void 0 === e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); return e; }
function _isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
function _superPropGet(t, e, o, r) { var p = _get(_getPrototypeOf(1 & r ? t.prototype : t), e, o); return 2 & r && "function" == typeof p ? function (t) { return p.apply(o, t); } : p; }
function _get() { return _get = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function (e, t, r) { var p = _superPropBase(e, t); if (p) { var n = Object.getOwnPropertyDescriptor(p, t); return n.get ? n.get.call(arguments.length < 3 ? e : r) : n.value; } }, _get.apply(null, arguments); }
...
var Row = /*#__PURE__*/function (_NavigationManager) {
  ...
  return _createClass(Row, [{
    ...
    key: "_template",
    value: function _template() {
      return Row_objectSpread(Row_objectSpread({}, _superPropGet(Row, "_template", this, 2)([])), {}, {
        direction: 'row'
      });
    }
  }, {
    key: "properties",
    get: function get() {
      return [].concat(_toConsumableArray(_superPropGet(Row, "properties", this)), ['lazyScroll', 'startLazyScrollIndex', 'stopLazyScrollIndex']);
    }
  }]);
}(NavigationManager/* default */.A);
 ...
 *
 */
var lightningTextDefaults = Object.entries(Object.getOwnPropertyDescriptors(lightning_esm/* default */.A.textures.TextTexture.prototype)).reduce(function (acc, _ref) {
  var _ref2 = _slicedToArray(_ref, 1),
    prop = _ref2[0];
  var value = lightning_esm/* default */.A.textures.TextTexture.prototype[prop];
...
var TextBox = /*#__PURE__*/function (_Base) {
  ...
  return _createClass(TextBox, [{
    ...
    value: function _setContent(content) {
      ...
      if (Array.isArray(content) || utils/* default.isMarkupString */.Ay.isMarkupString(content)) {
    ...
    key: "_construct",
    value: function _construct() {
      _superPropGet(TextBox, "_construct", this, 3)([]);
    ...
    value: function _updateInlineContent() {
      ...
      var inlineContentPatch = InlineContent/* default */.A.properties.reduce(function (acc, prop) {
    ...
    value: function _updateMarquee() {
      ...
      if (this.marquee) {
        ...
        if (!this._Marquee) {
          marqueePatch.type = Marquee/* default */.A;
        }
        if (this._isInlineContent) {
    ...
    set: function set(announce) {
      _superPropSet(TextBox, "announce", announce, this, 1, 1);
    }
  }, {
    key: "smooth",
    set: function set(v) {
      context/* default */.A.warn('warning: value smoothing is known to cause bugs with the TextBox - patch updated values instead.');
      _superPropSet(TextBox, "smooth", v, this, 1, 1);
    }
  }], [{
    key: "_template",
    value: function _template() {
    ...
    key: "properties",
    get: function get() {
      return [].concat(_toConsumableArray(InlineContent/* default */.A.properties), ['content', 'fixed', 'marquee', 'marqueeProps', 'hideOnLoad']);
    }
  }]);
}(Base/* default */.A);
...
var Metrics = /*#__PURE__*/function () {
  ...
  return _createClass(Metrics, [{
    ...
    set: function set(value) {
      ...
      logger/* default */.A.warn("context keyMetricsCallback expected a function. Received ".concat(_typeof(value)));
    }
  }]);
}();
...
var eventEmitterInstance = new lightning_esm/* default */.A.EventEmitter();
...
var fontLoader = function fontLoader(fonts) {
  ...
  var _loop = function _loop() {
    ...
    logger/* default */.A.info('Loading font', family);
  ...
  return Promise.all(promises).then(function (fontsLoaded) {
    ...
    if (loaded) {
      logger/* default */.A.log("Fonts loaded: ".concat(loaded));
    }
    ...
    if (failed) {
      logger/* default */.A.error("Unable to load fonts: ".concat(failed));
    }
  });
};
        ...
        case 3:
          customFontFaces = customFontFaces.filter(function (fontFace) {
            if (!fonts.find(function (font) {
              ...
              logger/* default */.A.info('Removing font', fontFace.family);
          ...
          break;
        case 6:
          logger/* default */.A.info('Unable to remove manually-added fonts');
        case 7:
        case "end":
...
function ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function _defineProperty(e, r, t) { return (r = theme_manager_toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
function _toConsumableArray(r) { return _arrayWithoutHoles(r) || _iterableToArray(r) || _unsupportedIterableToArray(r) || _nonIterableSpread(); }
function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return _arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray(r, a) : void 0; } }
function _iterableToArray(r) { if ("undefined" != typeof Symbol && null != r[Symbol.iterator] || null != r["@@iterator"]) return Array.from(r); }
...
function theme_manager_asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function theme_manager_asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { theme_manager_asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { theme_manager_asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
function theme_manager_classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function theme_manager_defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, theme_manager_toPropertyKey(o.key), o); } }
function theme_manager_createClass(e, r, t) { return r && theme_manager_defineProperties(e.prototype, r), t && theme_manager_defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function theme_manager_toPropertyKey(t) { var i = theme_manager_toPrimitive(t, "string"); return "symbol" == theme_manager_typeof(i) ? i : i + ""; }
...
var merge = {
  all: function all(objArray) {
    ...
    for (var i = 0; i < objArray.length; i++) {
      result = (0,utils/* clone */.o8)(result, objArray[i]);
    }
    return result;
  }
};
...
function base64ToBlobURL(base64String, mimeType) {
  ...
  try {
    ...
    logger/* default */.A.info('Unable to convert base64 image to URL');
    return null;
  }
}
var ThemeManager = /*#__PURE__*/function () {
  ...
  return theme_manager_createClass(ThemeManager, [{
    key: "_setCache",
        ...
        return theme_manager_regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              logger/* default */.A.warn("context theme expected an object. Received ".concat(theme_manager_typeof(value)));
              return _context.abrupt("return");
            case 4:
              this._clearCache();
        ...
        return theme_manager_regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              logger/* default */.A.warn('Sub theme name not specified');
            ...
            case 4:
              ...
              logger/* default */.A.warn("Sub theme name must be a string. Received an ".concat(theme_manager_typeof(subThemeName)));
              return _context2.abrupt("return");
            case 7:
              ...
              logger/* default */.A.warn("Could not set subTheme ".concat(subThemeName, ", value should be an object with properties. Received an ").concat(theme_manager_typeof(value)));
              return _context2.abrupt("return");
            case 10:
        ...
        return theme_manager_regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 5:
              ...
              logger/* default */.A.error("Unable to load font: ".concat(_context3.t0));
            case 8:
            case "end":
        ...
        return theme_manager_regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 4:
              ...
              logger/* default */.A.warn("Could not update subTheme ".concat(subThemeName, " due to invalid value"));
              return _context5.abrupt("return");
            case 7:
              globalTheme = this.getTheme();
              currentTheme = {};
            ...
            case 14:
              this._setCache("subTheme".concat(subThemeName), {
                original: (0,utils/* clone */.o8)(currentTheme, value),
                result: subTheme
              });
              if (triggerUpdate) this._emit("themeUpdate".concat(subThemeName));
    ...
    value: function _processTheme() {
      ...
      var themeString = JSON.stringify(theme, function (key, originalValue) {
        ...
        if (Array.isArray(value) && 2 === value.length && !value[0].targetComponent && value[0].length && typeof value[0] === 'string' && value[0].substr(0, 1) === '#' && typeof value[1] === 'number') {
          ...
          return (0,utils/* getHexColor */.H2)(value[0], value[1]);
          ...
          var themeValue = (0,utils/* getValFromObjPath */.ot)({
            theme: theme
          }, value);
          if (themeValue) {
            return themeValue;
          ...
          var validColor = (0,utils/* getValidColor */.MG)(value);
          if (validColor) {
            return validColor;
          }
          return value;
...
var Context = /*#__PURE__*/function () {
  ...
  return context_createClass(Context, [{
     ...
     */,
    set: function set(value) {
      logger/* default */.A.warn('Context.theme must be set using context.setTheme or context.updateTheme');
    }
    /**
     * @type {object}
     */
     ...
     */,
    set: function set(value) {
      logger/* default */.A.warn('Context.keyMetricsCallback must be set using context.setKeyMetricsCallback');
    }
    /**
     * @type {boolean}
     */
    ...
    key: "debug",
    get: function get() {
      return logger/* default */.A.debug;
    },
    set: function set(value) {
      logger/* default */.A.debug = value;
    }
    /**
     * @type {function}
     * @param {string} name
    ...
    key: "log",
    value: function log() {
      logger/* default */.A.log.apply(logger/* default */.A, arguments);
    }
    /**
     * @property {function}
     * @return {void}
    ...
    key: "info",
    value: function info() {
      logger/* default */.A.info.apply(logger/* default */.A, arguments);
    }
    /**
     * @property {function}
     * @return {void}
    ...
    key: "warn",
    value: function warn() {
      logger/* default */.A.warn.apply(logger/* default */.A, arguments);
    }
    /**
     * @property {function}
     * @return {void}
    ...
    value: function setSubThemes(subThemesObj) {
      if ('object' !== context_typeof(subThemesObj)) {
        logger/* default */.A.warn('subThemes must be an object');
        return;
      }
    ...
    value: function setLogCallback(value) {
      logger/* default */.A.logCallback = value;
    }
    /**
     * @property {function}
     * @return {void}
    ...
    value: function config() {
      ...
      for (var i = 0; i < configKeys.length; i++) {
        var setMethod = this['set' + (0,utils/* capitalizeFirstLetter */.Zr)(configKeys[i])];
        if (setMethod) {
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A: () => (/* binding */ loggerInstance)
/* harmony export */ });
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   t: () => (/* binding */ updateManager)
/* harmony export */ });
    ...
    value: function _runUpdatesTimeoutHandler() {
      ...
      this._updateThemeSet.forEach(function (component) {
        try {
          ...
          _context__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.error('Error updating component themes', e);
        }
      });
      ...
      this._requestUpdateSet.forEach(function (component) {
        try {
          ...
          _context__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.error('Error updating component', e);
        }
      });
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Rg: () => (/* binding */ translateAbbrev),
/* harmony export */   _8: () => (/* binding */ defaultAbbrevConfig)
/* harmony export */ });
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Ay: () => (/* binding */ withAnnouncer)
/* harmony export */ });
/* harmony import */ var _Speech__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("../../@lightningjs/ui-components/src/mixins/withAnnouncer/Speech.js");
/* harmony import */ var _abbreviations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("../../@lightningjs/ui-components/src/mixins/withAnnouncer/abbreviations.js");
...
function withAnnouncer(Base) {
  var speak = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _Speech__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A;
  ...
  return /*#__PURE__*/function (_Base) {
    ...
    return _createClass(_class, [{
      ...
      value: function _voiceOut(toAnnounce) {
        ...
        if (announcerOptions.abbreviationsConfig.abbreviationsPattern) {
          toSpeak = Array.isArray(toAnnounce) ? toAnnounce.map(function (phrase) {
            return (0,_abbreviations__WEBPACK_IMPORTED_MODULE_1__/* .translateAbbrev */ .Rg)(phrase, announcerOptions.abbreviationsConfig);
          }) : (0,_abbreviations__WEBPACK_IMPORTED_MODULE_1__/* .translateAbbrev */ .Rg)(toAnnounce, announcerOptions.abbreviationsConfig);
        }
      ...
      value: function _build() {
        var _this2 = this;
        _superPropGet(_class, "_build", this, 1) && _superPropGet(_class, "_build", this, 3)([]);
        this._debounceAnnounceFocusChanges = (0,_utils__WEBPACK_IMPORTED_MODULE_2__/* .debounce */ .sg)(this._announceFocusChanges.bind(this), Number.isInteger(this.announcerFocusDebounce) ? this.announcerFocusDebounce : 400);
        this.announcerTimeout = Number.isInteger(this.announcerTimeout) ? this.announcerTimeout : fiveMinutes;
        this._resetFocusTimer = (0,_utils__WEBPACK_IMPORTED_MODULE_2__/* .debounce */ .sg)(function () {
      ...
      value: function _firstEnable() {
        _superPropGet(_class, "_firstEnable", this, 1) && _superPropGet(_class, "_firstEnable", this, 3)([]);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A: () => (/* binding */ withHandleKey)
/* harmony export */ });
  ...
  return /*#__PURE__*/function (_Base) {
    ...
    return _createClass(_class, [{
      ...
      value: function _invokeKeyPayloadCallback(key) {
        if (this.metricsPayload && typeof _globals_context_index__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.keyMetricsCallback === 'function') {
          _globals_context_index__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.keyMetricsCallback(key, this.metricsPayload);
        }
      }
    }], [{
      key: "name",
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A: () => (/* binding */ withTags)
/* harmony export */ });
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey(o.key), o); } }
 ...
 */
var _sortObject = function sortObject(obj) {
  var sortedObj = {};
  Object.keys(obj).sort().forEach(function (key) {
    if (_typeof(obj[key]) === 'object' && obj[key] !== null && !Array.isArray(obj[key])) {
      sortedObj[key] = _sortObject(obj[key]); // Recursive call for nested objects
    } else {
...
function safeStringify(originalObj) {
  ...
  var seen = new WeakSet(); // WeakSet is used to store references to objects we've processed
...
function createSharedReferences() {
  ...
  var seenObjects = new Map(); // Store original reference -> shared reference

  function process(currentObj) {
    var queue = [currentObj]; // Use a queue for breadth-first traversal
...
function generatePayload(base, defaultStyle, toneItem, modeItem, tone, mode) {
  ...
  var payload = (0,utils/* clone */.o8)(defaultStyle, base);
  payload = (0,utils/* clone */.o8)(payload, tone === null || tone === void 0 ? void 0 : tone[toneItem]);
  payload = (0,utils/* clone */.o8)(payload, mode === null || mode === void 0 ? void 0 : mode[modeItem]);
  payload = (0,utils/* clone */.o8)(payload, (tone === null || tone === void 0 || (_tone$toneItem = tone[toneItem]) === null || _tone$toneItem === void 0 || (_tone$toneItem = _tone$toneItem.mode) === null || _tone$toneItem === void 0 ? void 0 : _tone$toneItem[modeItem]) || {});
  payload = (0,utils/* clone */.o8)(payload, (mode === null || mode === void 0 || (_mode$modeItem = mode[modeItem]) === null || _mode$modeItem === void 0 || (_mode$modeItem = _mode$modeItem.tone) === null || _mode$modeItem === void 0 ? void 0 : _mode$modeItem[toneItem]) || {});
  return payload;
}
...
var generateComponentStyleSource = function generateComponentStyleSource() {
  ...
  var solution = parsedStyles.reduce(function (acc, style) {
    return (0,utils/* clone */.o8)(acc, generateSolution(style, modeKeys, toneKeys));
  }, {});
...
var replaceAliasValues = function replaceAliasValues(value) {
  ...
  aliasProps.forEach(function (alias) {
    if (alias && typeof alias.prev === 'string' && typeof alias.curr === 'string') {
      !alias.skipWarn && str.search("\"".concat(alias.prev, "\":")) >= 0 && logger/* default */.A.warn("The style property \"".concat(alias.prev, "\" is deprecated and will be removed in a future release. Please use \"").concat(alias.curr, "\" instead."));
...
context/* default */.A.on('themeUpdate', function () {
...
function StyleManager_toConsumableArray(r) { return StyleManager_arrayWithoutHoles(r) || StyleManager_iterableToArray(r) || StyleManager_unsupportedIterableToArray(r) || StyleManager_nonIterableSpread(); }
function StyleManager_nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function StyleManager_unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return StyleManager_arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? StyleManager_arrayLikeToArray(r, a) : void 0; } }
function StyleManager_iterableToArray(r) { if ("undefined" != typeof Symbol && null != r[Symbol.iterator] || null != r["@@iterator"]) return Array.from(r); }
function StyleManager_arrayWithoutHoles(r) { if (Array.isArray(r)) return StyleManager_arrayLikeToArray(r); }
function StyleManager_arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, StyleManager_toPropertyKey(o.key), o); } }
function _createClass(e, r, t) { return r && _defineProperties(e.prototype, r), t && _defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
...
function _callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, _isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
function _possibleConstructorReturn(t, e) { if (e && ("object" == StyleManager_typeof(e) || "function" == typeof e)) return e; if (void 0 !== e) throw new TypeError("Derived constructors may only return object or undefined"); return _assertThisInitialized(t); }
function _assertThisInitialized(e) { if (void 0 === e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); return e; }
function _isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
function _getPrototypeOf(t) { return _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function (t) { return t.__proto__ || Object.getPrototypeOf(t); }, _getPrototypeOf(t); }
function _inherits(t, e) { if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function"); t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } }), Object.defineProperty(t, "prototype", { writable: !1 }), e && _setPrototypeOf(t, e); }
...
var StyleManager = /*#__PURE__*/function (_lng$EventEmitter) {
  ...
  function StyleManager() {
    ...
    _this = _callSuper(this, StyleManager, arguments);
  ...
  return _createClass(StyleManager, [{
    ...
    value: function setupListeners() {
      ...
      if (!this.component._targetSubTheme) {
        context/* default */.A.on('themeUpdate', this._boundThemeUpdate);
      } else {
        context/* default */.A.on("themeUpdate".concat(this.component._targetSubTheme), this._boundThemeUpdate);
      }
    }
  }, {
    key: "clearListeners",
    value: function clearListeners() {
      ...
      if (!this.component._targetSubTheme) {
        context/* default */.A.off('themeUpdate', this._boundThemeUpdate);
      } else {
        context/* default */.A.off("themeUpdate".concat(this.component._targetSubTheme), this._boundThemeUpdate);
      }
    }
    ...
    value: function update() {
      ...
      try {
        ...
        context/* default */.A.error('styleManager: ', error.message);
      }
    }
    ...
    set: function set(v) {
      context/* default */.A.warn('styleManager: Cannot mutate style directly');
    }
  }, {
    key: "props",
    get: function get() {
     ...
     */,
    set: function set(v) {
      context/* default */.A.warn('styleManager: Cannot mutate props directly');
    }
  }, {
    ...
    get: function get() {
      ...
      if (hasCustomStyle) {
        return getHash((0,utils/* clone */.o8)(this.component.constructor.__mixinStyle || {}, this.component._componentLevelStyle || {}));
      }
      return undefined;
    }
  }]);
}(lightning_esm/* default */.A.EventEmitter);
...
function withThemeStyles_classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function withThemeStyles_defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, withThemeStyles_toPropertyKey(o.key), o); } }
function withThemeStyles_createClass(e, r, t) { return r && withThemeStyles_defineProperties(e.prototype, r), t && withThemeStyles_defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function withThemeStyles_callSuper(t, o, e) { return o = withThemeStyles_getPrototypeOf(o), withThemeStyles_possibleConstructorReturn(t, withThemeStyles_isNativeReflectConstruct() ? Reflect.construct(o, e || [], withThemeStyles_getPrototypeOf(t).constructor) : o.apply(t, e)); }
function withThemeStyles_possibleConstructorReturn(t, e) { if (e && ("object" == withThemeStyles_typeof(e) || "function" == typeof e)) return e; if (void 0 !== e) throw new TypeError("Derived constructors may only return object or undefined"); return withThemeStyles_assertThisInitialized(t); }
function withThemeStyles_assertThisInitialized(e) { if (void 0 === e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); return e; }
function withThemeStyles_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (withThemeStyles_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
function _superPropSet(t, e, o, r, p, f) { return _set(withThemeStyles_getPrototypeOf(f ? t.prototype : t), e, o, r, p); }
function set(e, r, t, o) { return set = "undefined" != typeof Reflect && Reflect.set ? Reflect.set : function (e, r, t, o) { var f, i = _superPropBase(e, r); if (i) { if ((f = Object.getOwnPropertyDescriptor(i, r)).set) return f.set.call(o, t), !0; if (!f.writable) return !1; } if (f = Object.getOwnPropertyDescriptor(o, r)) { if (!f.writable) return !1; f.value = t, Object.defineProperty(o, r, f); } else withThemeStyles_defineProperty(o, r, t); return !0; }, set(e, r, t, o); }
function _set(e, r, t, o, f) { if (!set(e, r, t, o || e) && f) throw new TypeError("failed to set property"); return t; }
function withThemeStyles_defineProperty(e, r, t) { return (r = withThemeStyles_toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
function withThemeStyles_toPropertyKey(t) { var i = withThemeStyles_toPrimitive(t, "string"); return "symbol" == withThemeStyles_typeof(i) ? i : i + ""; }
...
function _superPropGet(t, e, o, r) { var p = _get(withThemeStyles_getPrototypeOf(1 & r ? t.prototype : t), e, o); return 2 & r && "function" == typeof p ? function (t) { return p.apply(o, t); } : p; }
function _get() { return _get = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function (e, t, r) { var p = _superPropBase(e, t); if (p) { var n = Object.getOwnPropertyDescriptor(p, t); return n.get ? n.get.call(arguments.length < 3 ? e : r) : n.value; } }, _get.apply(null, arguments); }
function _superPropBase(t, o) { for (; !{}.hasOwnProperty.call(t, o) && null !== (t = withThemeStyles_getPrototypeOf(t));); return t; }
function withThemeStyles_getPrototypeOf(t) { return withThemeStyles_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function (t) { return t.__proto__ || Object.getPrototypeOf(t); }, withThemeStyles_getPrototypeOf(t); }
function withThemeStyles_inherits(t, e) { if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function"); t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } }), Object.defineProperty(t, "prototype", { writable: !1 }), e && withThemeStyles_setPrototypeOf(t, e); }
function withThemeStyles_setPrototypeOf(t, e) { return withThemeStyles_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function (t, e) { return t.__proto__ = e, t; }, withThemeStyles_setPrototypeOf(t, e); }
function withThemeStyles_toConsumableArray(r) { return withThemeStyles_arrayWithoutHoles(r) || withThemeStyles_iterableToArray(r) || withThemeStyles_unsupportedIterableToArray(r) || withThemeStyles_nonIterableSpread(); }
function withThemeStyles_nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function withThemeStyles_unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return withThemeStyles_arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? withThemeStyles_arrayLikeToArray(r, a) : void 0; } }
function withThemeStyles_iterableToArray(r) { if ("undefined" != typeof Symbol && null != r[Symbol.iterator] || null != r["@@iterator"]) return Array.from(r); }
function withThemeStyles_arrayWithoutHoles(r) { if (Array.isArray(r)) return withThemeStyles_arrayLikeToArray(r); }
function withThemeStyles_arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
...
function withThemeStyles(Base) {
  ...
  return /*#__PURE__*/function (_Base) {
    function _class() {
      ...
      return withThemeStyles_callSuper(this, _class, arguments);
    }
    withThemeStyles_inherits(_class, _Base);
    return withThemeStyles_createClass(_class, [{
      key: "_construct",
      value: function _construct() {
        var _this = this;
        ...
        _superPropGet(_class, "_construct", this, 3)([]); // Important that this is called at the bottom to ensure that withThemeStyles is only initialized once per component to prevent potential memory leaks
      }
      ...
      value: function _setup() {
        _superPropGet(_class, "_setup", this, 1) && _superPropGet(_class, "_setup", this, 3)([]);
      ...
      value: function _attach() {
        _superPropGet(_class, "_attach", this, 3)([]);
      ...
      key: "_detach",
      value: function _detach() {
        _superPropGet(_class, "_detach", this, 3)([]);
      ...
      value: function _unfocus() {
        ...
        _superPropGet(_class, "_unfocus", this, 3)([]);
      }
      ...
      value: function _focus() {
        ...
        _superPropGet(_class, "_focus", this, 3)([]);
      }
      ...
      value: function queueThemeUpdate() {
        GlobalUpdateManager/* updateManager */.t.addUpdateTheme(this);
      }
    }, {
      key: "theme",
      get:
       ...
       */
      function get() {
        var subTheme = this._targetSubTheme && context/* default */.A.getSubTheme(this._targetSubTheme);
        return subTheme || context/* default */.A.theme;
      }
      ...
      set: function set(v) {
        if (Object.prototype.toString.call(v) !== '[object Object]') {
          context/* default */.A.error('style must be an object');
          return;
        }
      ...
      get: function get() {
        /** No longer supported */
        context/* default */.A.info('_componentStyle will soon be deprecated. Please use Component.style');
        return this._style;
      }
       ...
       */,
      set: function set(v) {
        context/* default */.A.info('style config is deprecated. Please use style = { base: {}, tone: {}, mode: {} }');
        this._styleConfig = v;
        this._styleManager.update();
      }
    }, {
      ...
      set: function set(v) {
        ...
        this._mode = v;
        var event = this["on".concat((0,utils/* capitalizeFirstLetter */.Zr)(v))];
      ...
      set: function set(v) {
        if (this._w === v) return;
        _superPropSet(_class, "w", v, this, 1, 1);
      ...
      set: function set(v) {
        if (this._h === v) return;
        _superPropSet(_class, "h", v, this, 1, 1);
      ...
      key: "__componentName",
      get: function get() {
        if (!_superPropGet(_class, "__componentName", this)) {
          throw new Error("A valid static __componentName property is required for theming to work properly. Please add this to the ".concat(this.constructor.name, " class."));
        }
        return _superPropGet(_class, "__componentName", this);
      }
    }, {
      key: "__mixinStyle",
      get: function get() {
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A: () => (/* binding */ withUpdates)
/* harmony export */ });
...
/* harmony import */ var _globals_global_update_manager_GlobalUpdateManager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("../../@lightningjs/ui-components/src/globals/global-update-manager/GlobalUpdateManager.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("../../@lightningjs/ui-components/src/utils/index.js");
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey(o.key), o); } }
function _createClass(e, r, t) { return r && _defineProperties(e.prototype, r), t && _defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
...
function mergeProps(componentConfigProp, prop) {
  ...
  if (_typeof(componentConfigProp) === 'object' && Object.keys(componentConfigProp).length && _typeof(prop) === 'object') {
    result = (0,_utils__WEBPACK_IMPORTED_MODULE_0__/* .clone */ .o8)(componentConfigProp, prop);
  }
  ...
  return {
    ...
    set: function set(value) {
      ...
      if (value !== oldValue) {
        ...
        var newValue = key === 'style' ? (0,_utils__WEBPACK_IMPORTED_MODULE_0__/* .clone */ .o8)(this[key], value) : value;
        if (_typeof(this[key]) === 'object' && this[key] !== null && this[key].style) {
          ...
          var style = (0,_utils__WEBPACK_IMPORTED_MODULE_0__/* .clone */ .o8)(this[key].style, value.style || {});
  ...
  return /*#__PURE__*/function (_Base) {
    ...
    return _createClass(_class, [{
      ...
      value: function queueRequestUpdate() {
        if (!this._isAttached()) return;
        _globals_global_update_manager_GlobalUpdateManager__WEBPACK_IMPORTED_MODULE_1__/* .updateManager */ .t.addRequestUpdate(this);
      }
    }, {
      key: "_firstEnable",
      value: function _firstEnable() {
        ...
        _globals_global_update_manager_GlobalUpdateManager__WEBPACK_IMPORTED_MODULE_1__/* .updateManager */ .t.deleteRequestUpdate(this);
        this.requestUpdate();
        _superPropGet(_class, "_firstEnable", this, 1) && _superPropGet(_class, "_firstEnable", this, 3)([]);
      }
    }, {
      ...
      value: function requestEarlyUpdate() {
        this._readyForUpdates = true;
        if (_globals_global_update_manager_GlobalUpdateManager__WEBPACK_IMPORTED_MODULE_1__/* .updateManager */ .t.hasQueuedRequestFor(this)) {
          _globals_global_update_manager_GlobalUpdateManager__WEBPACK_IMPORTED_MODULE_1__/* .updateManager */ .t.deleteRequestUpdate(this);
        ...
        if (this._readyForUpdates || force) {
          ...
          if (_typeof(result) === 'object' && result !== null && result["catch"]) {
            ...
            result["catch"](function (e) {
              _globals_context__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A.error("asyncronous _update() error in '".concat(_this2.constructor.__componentName, "'"), _this2, e);
            });
          }
        }
      }
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A: () => (/* binding */ FadeShader)
/* harmony export */ });
...
var FadeShader = /*#__PURE__*/function (_lng$shaders$WebGLDef) {
  function FadeShader(context) {
    ...
    _this = _callSuper(this, FadeShader, [context]);
    _this._margin = {
      left: 0,
      right: 0
    };
  ...
  return _createClass(FadeShader, [{
    ...
    value: function setupUniforms(operation) {
      _superPropGet(FadeShader, "setupUniforms", this, 3)([operation]);
...
}(_lightningjs_core__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.shaders.WebGLDefaultShader);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A: () => (/* binding */ CustomImageTexture)
/* harmony export */ });
/* harmony import */ var _lightningjs_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("../../../node_modules/@lightningjs/core/dist/lightning.esm.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
...
function createSvg(cb, stage, url, w, h) {
  ...
  if (!_lightningjs_core__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.Utils.isPS4) {
...
function imageLoader(_ref, cb) {
  ...
  if (!(src.substr(0, 5) == 'data:') && !_lightningjs_core__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.Utils.isPS4) {
...
var CustomImageTexture = /*#__PURE__*/function (_lng$Texture) {
  ...
  function CustomImageTexture(stage) {
    ...
    _this = _callSuper(this, CustomImageTexture, [stage]);
  ...
  return _createClass(CustomImageTexture, [{
    ...
    value: function getNonDefaults() {
      var obj = _superPropGet(CustomImageTexture, "getNonDefaults", this, 3)([]);
      if (this._src) {
        obj.src = this._src;
      }
      return obj;
...
}(_lightningjs_core__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.Texture);
...
/* harmony export */   H2: () => (/* binding */ getHexColor),
/* harmony export */   Hd: () => (/* binding */ reduceFraction),
/* harmony export */   IG: () => (/* binding */ getShortestDistance),
/* harmony export */   MG: () => (/* binding */ getValidColor),
/* harmony export */   Ny: () => (/* binding */ isComponentOnScreen),
/* harmony export */   T9: () => (/* binding */ max),
/* harmony export */   WI: () => (/* binding */ measureTextWidth),
/* harmony export */   XG: () => (/* binding */ getMaxRoundRadius),
/* harmony export */   Ym: () => (/* binding */ parseInlineContent),
/* harmony export */   Zr: () => (/* binding */ capitalizeFirstLetter),
/* harmony export */   _l: () => (/* binding */ getWidthByColumnSpan),
/* harmony export */   cN: () => (/* binding */ getWidthByUpCount),
/* harmony export */   du: () => (/* binding */ stringifyCompare),
/* harmony export */   l6: () => (/* binding */ getH),
/* harmony export */   ls: () => (/* binding */ getX),
/* harmony export */   o8: () => (/* binding */ clone),
/* harmony export */   ot: () => (/* binding */ getValFromObjPath),
/* harmony export */   p9: () => (/* binding */ watchForUpdates),
/* harmony export */   q: () => (/* binding */ getW),
/* harmony export */   s6: () => (/* binding */ getY),
...
function getValidColor(color) {
  if (typeof color === 'string' || typeof color === 'number') {
    if (/^0x[0-9a-fA-F]{8}/g.test(color)) {
      ...
      return _lightningjs_core__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.StageUtils.getArgbNumber(rgba);
    }
  }
  return null;
}
...
function watchForUpdates(_ref5) {
  ...
  if (!(element !== null && element !== void 0 && element.isElement)) {
    _globals_context_logger__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.error("watchForUpdates: Expected a Lightning Element passed to element parameter, received ".concat(_typeof(element)));
  }
...
function getMaxRoundRadius(radius, width, height) {
  ...
  var maxRadius = function maxRadius(r) {
    return Math.max(0, Math.min(r, Math.min(width, height) / 2) + offset);
  };
  return Array.isArray(radius) ? radius.map(function (r) {
    return Number(maxRadius(r)) || 0;
...
var themeSelect = function themeSelect(theme) {
  ...
  return targetTheme.name && context/* default */.A.theme.name !== targetTheme.name ? context/* default */.A.setTheme(targetTheme) : Promise.resolve();
};
...
var registerEventListeners = function registerEventListeners() {
  ...
  context/* default */.A.storybookCustomTheme = JSON.parse(JSON.stringify(context/* default */.A.theme));
};
...
var createApp = function createApp(parameters) {
  ...
  }((0,withAnnouncer/* default */.Ay)(lightning_esm/* default */.A.Application, Speech/* default */.A, announcerOptions)))(appParams);
...
function withLightning_defineProperty(e, r, t) { return (r = withLightning_toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
function withLightning_classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function withLightning_defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, withLightning_toPropertyKey(o.key), o); } }
function withLightning_createClass(e, r, t) { return r && withLightning_defineProperties(e.prototype, r), t && withLightning_defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function withLightning_toPropertyKey(t) { var i = withLightning_toPrimitive(t, "string"); return "symbol" == withLightning_typeof(i) ? i : i + ""; }
...
function withLightning_callSuper(t, o, e) { return o = withLightning_getPrototypeOf(o), withLightning_possibleConstructorReturn(t, withLightning_isNativeReflectConstruct() ? Reflect.construct(o, e || [], withLightning_getPrototypeOf(t).constructor) : o.apply(t, e)); }
function withLightning_possibleConstructorReturn(t, e) { if (e && ("object" == withLightning_typeof(e) || "function" == typeof e)) return e; if (void 0 !== e) throw new TypeError("Derived constructors may only return object or undefined"); return withLightning_assertThisInitialized(t); }
function withLightning_assertThisInitialized(e) { if (void 0 === e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); return e; }
function withLightning_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (withLightning_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
function _superPropGet(t, e, o, r) { var p = _get(withLightning_getPrototypeOf(1 & r ? t.prototype : t), e, o); return 2 & r && "function" == typeof p ? function (t) { return p.apply(o, t); } : p; }
function _get() { return _get = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function (e, t, r) { var p = _superPropBase(e, t); if (p) { var n = Object.getOwnPropertyDescriptor(p, t); return n.get ? n.get.call(arguments.length < 3 ? e : r) : n.value; } }, _get.apply(null, arguments); }
function _superPropBase(t, o) { for (; !{}.hasOwnProperty.call(t, o) && null !== (t = withLightning_getPrototypeOf(t));); return t; }
function withLightning_getPrototypeOf(t) { return withLightning_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function (t) { return t.__proto__ || Object.getPrototypeOf(t); }, withLightning_getPrototypeOf(t); }
function withLightning_inherits(t, e) { if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function"); t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } }), Object.defineProperty(t, "prototype", { writable: !1 }), e && withLightning_setPrototypeOf(t, e); }
function withLightning_setPrototypeOf(t, e) { return withLightning_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function (t, e) { return t.__proto__ = e, t; }, withLightning_setPrototypeOf(t, e); }
/**
 * Copyright 2023 Comcast Cable Communications Management, LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
var withLightning = function withLightning(StoryComponent, _ref2) {
  ...
  // toggle stage color
  !globals.stageColor ? app.stage.setClearColor(utils/* default.getValidColor */.Ay.getValidColor('#21232A')) : app.stage.setClearColor(utils/* default.getValidColor */.Ay.getValidColor('#cccccc'));
      ...
      StoryComponent: {
        type: /*#__PURE__*/function (_StoryComponent) {
          function type() {
            ...
            return withLightning_callSuper(this, type, arguments);
          }
          withLightning_inherits(type, _StoryComponent);
          return withLightning_createClass(type, [{
            key: "componentTarget",
            get:
            ...
            value: function _init() {
              ...
              _superPropGet(type, "_init", this, 3)([]);
            ...
            value: function _states() {
              return [/*#__PURE__*/function (_this3) {
                function ModeUnfocusState() {
                  ...
                  return withLightning_callSuper(this, ModeUnfocusState, arguments);
                }
                withLightning_inherits(ModeUnfocusState, _this3);
                return withLightning_createClass(ModeUnfocusState, [{
                  key: "_getFocused",
                  value: function _getFocused() {
                    return this;
                  }
                ...
                function ModeFocusState() {
                  ...
                  return withLightning_callSuper(this, ModeFocusState, arguments);
                }
                withLightning_inherits(ModeFocusState, _this4);
                return withLightning_createClass(ModeFocusState, [{
                  key: "_getFocused",
                  value: function _getFocused() {
        ...
        x: context/* default */.A.theme.layout.marginX,
        y: context/* default */.A.theme.layout.marginY
      }
    });
    app._refocus();
  }
    ...
    if (!app.tag('StoryDetails')) {
      var StoryDetails = {
        StoryDetails: {
          ...
          style: {
            textStyle: {
              wordWrapWidth: context/* default */.A.theme.layout.screenW - context/* default */.A.theme.spacer.sm * 2
            }
          },
          x: context/* default */.A.theme.spacer.sm,
          y: context/* default */.A.theme.spacer.sm,
          onAfterUpdate: function onAfterUpdate(_ref3) {
            var y = _ref3.y,
              h = _ref3.h;
            if (h > context/* default */.A.theme.layout.marginY) {
              app.tag('StoryComponent').y = y + h + context/* default */.A.theme.spacer.xl;
            }
          }
        }
      };
...
/***/ "../../@lightningjs/ui-components-test-utils/src/docs lazy recursive ^\\.\\/.*$ include: (?%21.*node_modules)(?:\\/@lightningjs\\/ui-components-test-utils\\/src\\/docs(?:\\/(?%21\\.)(?:(?:(?%21(?:^%7C\\/)\\.).)*?)\\/%7C\\/%7C$)(?%21\\.)(?=.)[^/]*?\\.mdx)$":
...
/***/ "../../@lightningjs/ui-components-test-utils/src/docs lazy recursive ^\\.\\/.*$ include: (?%21.*node_modules)(?:\\/@lightningjs\\/ui-components-test-utils\\/src\\/docs\\/(?%21\\.)(?=.)[^/]*?\\.mdx)$":
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
/***/ "../../@lightningjs/ui-components/src lazy recursive ^\\.\\/.*$ include: (?%21.*node_modules)(?:\\/@lightningjs\\/ui-components\\/src(?:\\/(?%21\\.)(?:(?:(?%21(?:^%7C\\/)\\.).)*?)\\/%7C\\/%7C$)(?%21\\.)(?=.)[^/]*?\\.mdx)$":
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
/***/ "../../@lightningjs/ui-components/src lazy recursive ^\\.\\/.*$ include: (?%21.*node_modules)(?:\\/@lightningjs\\/ui-components\\/src(?:\\/(?%21\\.)(?:(?:(?%21(?:^%7C\\/)\\.).)*?)\\/%7C\\/%7C$)(?%21\\.)(?=.)[^/]*?\\.stories\\.(js%7Cjsx%7Cts%7Ctsx))$":
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
/***/ "./src lazy recursive ^\\.\\/.*$ include: (?%21.*node_modules)(?:\\/src\\/(?%21\\.)(?=.)[^/]*?\\.mdx)$":
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
const importers = [
  async (path) => {
    ...
    return __webpack_require__("./src lazy recursive ^\\.\\/.*$ include: (?%21.*node_modules)(?:\\/src\\/(?%21\\.)(?=.)[^/]*?\\.mdx)$")("./" + pathRemainder);
  }
  ,
  async (path) => {
    ...
    return __webpack_require__("../../@lightningjs/ui-components/src lazy recursive ^\\.\\/.*$ include: (?%21.*node_modules)(?:\\/@lightningjs\\/ui-components\\/src(?:\\/(?%21\\.)(?:(?:(?%21(?:^%7C\\/)\\.).)*?)\\/%7C\\/%7C$)(?%21\\.)(?=.)[^/]*?\\.mdx)$")("./" + pathRemainder);
  }
  ,
  async (path) => {
    ...
    const pathRemainder = path.substring(37);
    return __webpack_require__("../../@lightningjs/ui-components/src lazy recursive ^\\.\\/.*$ include: (?%21.*node_modules)(?:\\/@lightningjs\\/ui-components\\/src(?:\\/(?%21\\.)(?:(?:(?%21(?:^%7C\\/)\\.).)*?)\\/%7C\\/%7C$)(?%21\\.)(?=.)[^/]*?\\.stories\\.(js%7Cjsx%7Cts%7Ctsx))$")("./" + pathRemainder);
  }
  ,
  async (path) => {
    ...
    return __webpack_require__("../../@lightningjs/ui-components-test-utils/src/docs lazy recursive ^\\.\\/.*$ include: (?%21.*node_modules)(?:\\/@lightningjs\\/ui-components-test-utils\\/src\\/docs\\/(?%21\\.)(?=.)[^/]*?\\.mdx)$")("./" + pathRemainder);
  }
  ,
  async (path) => {
    if (!/^(?:\.\.\/\.\.\/@lightningjs\/ui-components-test-utils\/src\/docs(?:\/(?!\.)(?:(?:(?!(?:^|\/)\.).)*?)\/|\/|$)(?!\.)(?=.)[^/]*?\.mdx)$/.exec(path)) {
    ...
    const pathRemainder = path.substring(53);
    return __webpack_require__("../../@lightningjs/ui-components-test-utils/src/docs lazy recursive ^\\.\\/.*$ include: (?%21.*node_modules)(?:\\/@lightningjs\\/ui-components-test-utils\\/src\\/docs(?:\\/(?%21\\.)(?:(?:(?%21(?:^%7C\\/)\\.).)*?)\\/%7C\\/%7C$)(?%21\\.)(?=.)[^/]*?\\.mdx)$")("./" + pathRemainder);
  }
...
(0,external_STORYBOOK_MODULE_PREVIEW_API_.composeConfigs)([__webpack_require__("../../../node_modules/@storybook/html/dist/entry-preview.mjs"),__webpack_require__("../../../node_modules/@storybook/html/dist/entry-preview-docs.mjs"),__webpack_require__("../../../node_modules/@storybook/addon-essentials/dist/actions/preview.mjs"),__webpack_require__("../../../node_modules/@storybook/addon-essentials/dist/highlight/preview.mjs"),__webpack_require__("../../../node_modules/@storybook/addon-docs/dist/preview.mjs"),__webpack_require__("./.storybook/preview.js"),]);
...
/******/ __webpack_require__.O(0, [2114], () => (__webpack_exec__("./storybook-config-entry.js")));
/******/ var __webpack_exports__ = __webpack_require__.O();
/******/ }
]);
//# sourceMappingURL=main.ef89d967.iframe.bundle.js.map