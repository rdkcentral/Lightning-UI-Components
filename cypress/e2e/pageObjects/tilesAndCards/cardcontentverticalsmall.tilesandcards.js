...
class CardContentVerticalSmall extends LUIComponent {
  constructor() {
    super({ type: 'tiles-cards', componentName: 'cardcontentverticalsmall' });
  }

  get cardContentVerticalSmall() {
    return 'div[type=CardContentVerticalSmall]';
  }

  get contentTile() {
    return `${this.cardContentVerticalSmall} > div[ref=Tile]`;
  }

  get metadata() {
    return `${this.cardContentVerticalSmall} > div[type=MetadataCardContent]`;
  }
...
module.exports = new CardContentVerticalSmall();
