...
class CardContentHorizontal extends LUIComponent {
  constructor() {
    super({ type: 'tiles-cards', componentName: 'cardcontenthorizontal' });
  }

  get cardContentHorizontal() {
    return 'div[type=CardContentHorizontal]';
  }

  get contentTile() {
    return `${this.cardContentHorizontal} > div[ref=Tile]`;
  }
  ...
  get metadata() {
    return `${this.cardContentHorizontal} > div[type=MetadataCardContent]`;
  }
...
module.exports = new CardContentHorizontal();
