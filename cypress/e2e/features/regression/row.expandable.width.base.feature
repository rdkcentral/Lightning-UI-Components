@regression @row @expandableWidth @2112264
...
Feature: LUI Row Expandable width component
  ...
  Scenario: Verify the dimensions and count of the Row Focus Height Change Elements
    ...
    And I verify focused element has width of 350.0 and height of 100.0 and non-focused elements have width of 250.0 and height of 100.0
