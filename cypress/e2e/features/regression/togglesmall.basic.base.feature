...
Feature: LUI ToggleSmall Basic component
  ...
  Scenario: Verify the dimensions of the ToggleSmall Basic Element
    Then I verify that the 'width' of 'ToggleSmall' 'Toggle' component is '60px'
    And I verify that the 'height' of 'ToggleSmall' 'Toggle' component is '30px'
  ...
  Scenario: Verify the ToggleSmall Basic checked state
    ...
    Then I verify that the 'left' of 'ToggleSmall' 'Knob' component is '34px'
