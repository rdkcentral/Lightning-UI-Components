@sanity @cardAboutStacked @2111312
...
Feature: LUI CardAbout Stacked component
  ...
  Scenario Outline: Verify that CardAboutStacked modes
    When I set the 'mode' to 'modeValue' for 'cardaboutstacked' component
    Then I verify the 'mode' is 'modeValue' for 'cardaboutstacked' 'cardaboutstacked'
  Examples:
    | modeValue |
    | unfocused |
    | focused   |
  ...
  Scenario: Verify the default values
    ...
    And I verify the 'mode' is 'focused' for 'cardaboutstacked' 'cardaboutstacked'