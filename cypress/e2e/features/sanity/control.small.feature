...
Feature: LUI Control Small component
    ...
    Scenario: Verify the ControlSmall modes
      ...
      Then I verify the 'mode' is 'unfocused' for 'ControlSmall' 'Basic'
      And I set the 'mode' to 'focused' for 'ControlSmall' component
      And I verify the 'mode' is 'focused' for 'ControlSmall' 'Basic'
      And I set the 'mode' to 'disabled' for 'ControlSmall' component
      And I verify the 'mode' is 'disabled' for 'ControlSmall' 'Basic'
    ...
    Scenario: Verify the ControlSmall shouldCollapse state
      ...
      And I verify that the 'width' of 'Control' 'ControlSmall' component is '90px'
      And I set the 'shouldCollapse' to 'false' for 'ControlSmall' component
      And I verify that the 'width' of 'Control' 'ControlSmall' component is '104px'
      And I set the 'mode' to 'disabled' for 'ControlSmall' component
