...
function CheckboxSmall_stories_typeof(o) {
  "@babel/helpers - typeof";

  return CheckboxSmall_stories_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) {
    return typeof o;
  } : function (o) {
    return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o;
  }, CheckboxSmall_stories_typeof(o);
}
...
function _defineProperty(obj, key, value) {
  key = CheckboxSmall_stories_toPropertyKey(key);
  if (key in obj) {
...
function CheckboxSmall_stories_classCallCheck(instance, Constructor) {
  if (!(instance instanceof Constructor)) {
    throw new TypeError("Cannot call a class as a function");
  }
}
function CheckboxSmall_stories_defineProperties(target, props) {
  for (var i = 0; i < props.length; i++) {
    var descriptor = props[i];
    descriptor.enumerable = descriptor.enumerable || false;
    descriptor.configurable = true;
    if ("value" in descriptor) descriptor.writable = true;
    Object.defineProperty(target, CheckboxSmall_stories_toPropertyKey(descriptor.key), descriptor);
  }
}
function CheckboxSmall_stories_createClass(Constructor, protoProps, staticProps) {
  if (protoProps) CheckboxSmall_stories_defineProperties(Constructor.prototype, protoProps);
  if (staticProps) CheckboxSmall_stories_defineProperties(Constructor, staticProps);
  Object.defineProperty(Constructor, "prototype", {
    writable: false
  });
  return Constructor;
}
function CheckboxSmall_stories_toPropertyKey(t) {
  var i = CheckboxSmall_stories_toPrimitive(t, "string");
  return "symbol" == CheckboxSmall_stories_typeof(i) ? i : String(i);
}
function CheckboxSmall_stories_toPrimitive(t, r) {
  if ("object" != CheckboxSmall_stories_typeof(t) || !t) return t;
  var e = t[Symbol.toPrimitive];
  if (void 0 !== e) {
    var i = e.call(t, r || "default");
    if ("object" != CheckboxSmall_stories_typeof(i)) return i;
    throw new TypeError("@@toPrimitive must return a primitive value.");
  }
  return ("string" === r ? String : Number)(t);
}
function CheckboxSmall_stories_inherits(subClass, superClass) {
  ...
  if (superClass) CheckboxSmall_stories_setPrototypeOf(subClass, superClass);
}
function CheckboxSmall_stories_setPrototypeOf(o, p) {
  CheckboxSmall_stories_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) {
    o.__proto__ = p;
    return o;
  };
  return CheckboxSmall_stories_setPrototypeOf(o, p);
}
function CheckboxSmall_stories_createSuper(Derived) {
  var hasNativeReflectConstruct = CheckboxSmall_stories_isNativeReflectConstruct();
  return function _createSuperInternal() {
    var Super = CheckboxSmall_stories_getPrototypeOf(Derived),
      result;
    if (hasNativeReflectConstruct) {
      var NewTarget = CheckboxSmall_stories_getPrototypeOf(this).constructor;
      result = Reflect.construct(Super, arguments, NewTarget);
    } else {
      result = Super.apply(this, arguments);
    }
    return CheckboxSmall_stories_possibleConstructorReturn(this, result);
  };
}
function CheckboxSmall_stories_possibleConstructorReturn(self, call) {
  if (call && (CheckboxSmall_stories_typeof(call) === "object" || typeof call === "function")) {
    return call;
  } else if (call !== void 0) {
    throw new TypeError("Derived constructors may only return object or undefined");
  }
  return CheckboxSmall_stories_assertThisInitialized(self);
}
function CheckboxSmall_stories_assertThisInitialized(self) {
  if (self === void 0) {
    throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
  }
  return self;
}
function CheckboxSmall_stories_isNativeReflectConstruct() {
...
function CheckboxSmall_stories_getPrototypeOf(o) {
  CheckboxSmall_stories_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) {
    return o.__proto__ || Object.getPrototypeOf(o);
  };
  return CheckboxSmall_stories_getPrototypeOf(o);
}
/* eslint-disable */
// @ts-nocheck
...
};;const __namedExportsOrder = ["CheckboxSmall"];
  ...
  _createClass(Checkbox, [{
    ...
    value: function _updateBody() {
      ...
      this._Body.patch({
        ...
        width, height, (0,utils/* getMaxRoundRadius */.JS)(this.style.radius, width, height, this.style.strokeWidth * 2 - 2), 0, null, true, bodyColor)
      });
    }
  }, {
    key: "_updateStroke",
    value: function _updateStroke() {
      this._Stroke.patch({
        texture: lightning_esm/* default */.Z.Tools.getRoundRect(
        // Compensating for the extra 2 pixels getRoundRect adds
        this.w - 2, this.h - 2, (0,utils/* getMaxRoundRadius */.JS)(this.style.radius, this.w - 2, this.h - 2), this.style.strokeWidth, this.style.strokeColor, false)
      });
    }
  }, {
    key: "_updateOpacity",
...
//# sourceMappingURL=components-Checkbox-CheckboxSmall-stories.ad487386.iframe.bundle.js.map