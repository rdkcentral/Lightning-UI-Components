"use strict";
(self["webpackChunklightning_ui_docs"] = self["webpackChunklightning_ui_docs"] || []).push([[4253],{
...
// add remount to all Row argTypes individually since Row uses remountAll
// TitleRow title prop can be updated without requiring a remount
var rowArgTypes = Object.keys(_Row_Row_stories__WEBPACK_IMPORTED_MODULE_1__.Row.argTypes).reduce(function (acc, key) {
  acc[key] = _objectSpread(_objectSpread({}, _Row_Row_stories__WEBPACK_IMPORTED_MODULE_1__.Row.argTypes[key]), {}, {
    remount: key !== 'mode'
  });
  return acc;
}, {});
...
//# sourceMappingURL=4253.8070280b.iframe.bundle.js.map