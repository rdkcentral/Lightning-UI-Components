...
import radiusTable from '/bin/scriptingFiles/radius.md';
import colorsTable from '/bin/scriptingFiles/colors.md';
import typographyTable from '/bin/scriptingFiles/typography.md';
<style>{`
.sbdocs.sbdocs-li {
