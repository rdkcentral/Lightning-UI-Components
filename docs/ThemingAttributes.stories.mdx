...
import radiusTable from '../bin/scriptingFiles/radiusTable.md';
import typographyTable from '../bin/scriptingFiles/typographyTable.md';
import colorsTable from '../bin/scriptingFiles/colorsTable.md';
<style>{`
.sbdocs.sbdocs-li {
