...
import radiusTable from '/bin/themePropertyTables/radius.md';
import colorsTable from '/bin/themePropertyTables/colors.md';
import typographyTable from '/bin/themePropertyTables/typography.md';
...
```
<Description>{colorsTable}</Description>
