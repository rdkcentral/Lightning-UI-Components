"use strict";
(self["webpackChunklightning_ui_docs"] = self["webpackChunklightning_ui_docs"] || []).push([[1373],{
...
function TabBar_toPropertyKey(arg) { var key = TabBar_toPrimitive(arg, "string"); return TabBar_typeof(key) === "symbol" ? key : String(key); }
function TabBar_toPrimitive(input, hint) { if (TabBar_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (TabBar_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
...
var TabBar = /*#__PURE__*/function (_Base) {
  ...
  TabBar_createClass(TabBar, [{
    ...
    value: function _selectedTabChange() {
...
var _Basic$parameters, _Basic$parameters2, _CustomTabs$parameter, _CustomTabs$parameter2, _MultipleRows$paramet, _MultipleRows$paramet2;
function TabBar_stories_typeof(o) { "@babel/helpers - typeof"; return TabBar_stories_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, TabBar_stories_typeof(o); }
function TabBar_stories_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function TabBar_stories_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, TabBar_stories_toPropertyKey(descriptor.key), descriptor); } }
function TabBar_stories_createClass(Constructor, protoProps, staticProps) { if (protoProps) TabBar_stories_defineProperties(Constructor.prototype, protoProps); if (staticProps) TabBar_stories_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function TabBar_stories_get() { if (typeof Reflect !== "undefined" && Reflect.get) { TabBar_stories_get = Reflect.get.bind(); } else { TabBar_stories_get = function _get(target, property, receiver) { var base = TabBar_stories_superPropBase(target, property); if (!base) return; var desc = Object.getOwnPropertyDescriptor(base, property); if (desc.get) { return desc.get.call(arguments.length < 3 ? target : receiver); } return desc.value; }; } return TabBar_stories_get.apply(this, arguments); }
function TabBar_stories_superPropBase(object, property) { while (!Object.prototype.hasOwnProperty.call(object, property)) { object = TabBar_stories_getPrototypeOf(object); if (object === null) break; } return object; }
function TabBar_stories_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) TabBar_stories_setPrototypeOf(subClass, superClass); }
function TabBar_stories_setPrototypeOf(o, p) { TabBar_stories_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return TabBar_stories_setPrototypeOf(o, p); }
function TabBar_stories_createSuper(Derived) { var hasNativeReflectConstruct = TabBar_stories_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = TabBar_stories_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = TabBar_stories_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return TabBar_stories_possibleConstructorReturn(this, result); }; }
function TabBar_stories_possibleConstructorReturn(self, call) { if (call && (TabBar_stories_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return TabBar_stories_assertThisInitialized(self); }
function TabBar_stories_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
function TabBar_stories_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function TabBar_stories_getPrototypeOf(o) { TabBar_stories_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return TabBar_stories_getPrototypeOf(o); }
function TabBar_stories_ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function TabBar_stories_objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? TabBar_stories_ownKeys(Object(t), !0).forEach(function (r) { TabBar_stories_defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : TabBar_stories_ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function TabBar_stories_defineProperty(obj, key, value) { key = TabBar_stories_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function TabBar_stories_toPropertyKey(arg) { var key = TabBar_stories_toPrimitive(arg, "string"); return TabBar_stories_typeof(key) === "symbol" ? key : String(key); }
function TabBar_stories_toPrimitive(input, hint) { if (TabBar_stories_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (TabBar_stories_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
/* eslint-disable */
// @ts-nocheck
...
MultipleRows.argTypes = {};
Basic.parameters = TabBar_stories_objectSpread(TabBar_stories_objectSpread({}, Basic.parameters), {}, {
  docs: TabBar_stories_objectSpread(TabBar_stories_objectSpread({}, (_Basic$parameters = Basic.parameters) === null || _Basic$parameters === void 0 ? void 0 : _Basic$parameters.docs), {}, {
    source: TabBar_stories_objectSpread({
      originalSource: "() => class Basic extends lng.Component {\n  static _template() {\n    return {\n      TabBar: {\n        type: TabBarComponent,\n        w: 1920 - 160,\n        tabs: [{\n          type: Tab,\n          title: 'No Content Tab'\n        }, {\n          type: Tab,\n          title: 'Tab 1',\n          tabContent: {\n            type: Row,\n            items: tilesA,\n            autoResizeHeight: true,\n            lazyScroll: true\n          }\n        }, {\n          type: Tab,\n          title: 'Tab 2',\n          tabContent: col1\n        }, {\n          type: Tab,\n          title: 'Tab 3',\n          tabContent: rowFunction\n        }, {\n          type: Tab,\n          title: 'Tab 4',\n          tabContent: colPromise\n        }]\n      }\n    };\n  }\n}"
...
CustomTabs.parameters = TabBar_stories_objectSpread(TabBar_stories_objectSpread({}, CustomTabs.parameters), {}, {
  docs: TabBar_stories_objectSpread(TabBar_stories_objectSpread({}, (_CustomTabs$parameter = CustomTabs.parameters) === null || _CustomTabs$parameter === void 0 ? void 0 : _CustomTabs$parameter.docs), {}, {
    source: TabBar_stories_objectSpread({
      originalSource: "() => class CustomTabs extends lng.Component {\n  static _template() {\n    return {\n      TabBar: {\n        type: TabBarComponent,\n        w: 1920 - 160,\n        tabs: [{\n          type: CustomButton,\n          fixed: true,\n          prefix: [{\n            type: Icon,\n            icon: viewAllIcon,\n            w: 20,\n            h: 20\n          }],\n          centerInParent: true,\n          backgroundType: 'fill'\n        }, {\n          type: CustomTile,\n          ...tileProps,\n          tabContent: {\n            type: Row,\n            items: tilesA,\n            autoResizeHeight: true,\n            lazyScroll: true\n          }\n        }, {\n          type: CustomTile,\n          ...tileProps,\n          tabContent: col1\n        }, {\n          type: CustomTile,\n          ...tileProps,\n          tabContent: rowFunction\n        }, {\n          type: CustomTile,\n          ...tileProps,\n          tabContent: colPromise\n        }]\n      }\n    };\n  }\n}"
    }, (_CustomTabs$parameter2 = CustomTabs.parameters) === null || _CustomTabs$parameter2 === void 0 || (_CustomTabs$parameter2 = _CustomTabs$parameter2.docs) === null || _CustomTabs$parameter2 === void 0 ? void 0 : _CustomTabs$parameter2.source)
  })
});
MultipleRows.parameters = TabBar_stories_objectSpread(TabBar_stories_objectSpread({}, MultipleRows.parameters), {}, {
  docs: TabBar_stories_objectSpread(TabBar_stories_objectSpread({}, (_MultipleRows$paramet = MultipleRows.parameters) === null || _MultipleRows$paramet === void 0 ? void 0 : _MultipleRows$paramet.docs), {}, {
    source: TabBar_stories_objectSpread({
      originalSource: "() => class MultipleRows extends lng.Component {\n  static _template() {\n    return {\n      TabBar: {\n        type: TabBarComponent,\n        autoResizeWidth: true,\n        tabs: [{\n          type: Tab,\n          title: 'No Content Tab'\n        }, {\n          type: Tab,\n          title: 'Multiple Rows',\n          tabContent: {\n            type: ColumnContainer\n          }\n        }, {\n          type: Tab,\n          title: 'Tab 2',\n          tabContent: col1\n        }]\n      }\n    };\n  }\n}"
    }, (_MultipleRows$paramet2 = MultipleRows.parameters) === null || _MultipleRows$paramet2 === void 0 || (_MultipleRows$paramet2 = _MultipleRows$paramet2.docs) === null || _MultipleRows$paramet2 === void 0 ? void 0 : _MultipleRows$paramet2.source)
  })
});
var __namedExportsOrder = ["Basic", "CustomTabs", "MultipleRows"];
...
//# sourceMappingURL=1373.39e38afb.iframe.bundle.js.map