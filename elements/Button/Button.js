...
class Button extends Surface {
  ...
  static get properties() {
    return ['checkbox', 'fixed', 'icon', 'justify', 'prefixStyle', 'title'];
  }
  ...
  _getPrefixStyle() {
    return !!this._prefixStyle ? this._prefixStyle : this.style.prefixStyle;
  }
  ...
  get _prefixW() {
    return this._hasPrefix
      ? this._hasTitle
        ? this.prefixStyle.w + this.style.prefixMargin
        : this.prefixStyle.w
      : 0;
  }
