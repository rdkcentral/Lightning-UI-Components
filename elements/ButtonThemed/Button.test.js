...
describe('Themed Button', () => {
  ...
  describe('dimensions', () => {
    it('should grow width dynamically', () => {
      ...
      expect(component.w).toBeGreaterThan(component._componentStyles.minWidth);
    });
  ...
  describe('focus', () => {
    it('has a default unfocus text color', () => {
      expect(component._Title.textColor).toBe(
        component._componentStyles.textColorUnfocused
      );
    });
    it('has a focus text color', () => {
      ...
      expect(component._Title.textColor).toBe(
        component._componentStyles.textColorFocused
      );
    });
  ...
  describe('prefix', () => {
    ...
    it('should apply a margin if both prefix and text exist', () => {
      ...
      const titleXOffset =
        component._componentStyles.prefixMargin +
        component._componentStyles.prefixStyle.w;
