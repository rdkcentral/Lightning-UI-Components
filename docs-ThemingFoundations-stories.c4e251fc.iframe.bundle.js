...
var Explanation = /*#__PURE__*/function (_Base) {
  ...
  return Explanation;
}(_components_Base_Base__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A);
...
var Radius = /*#__PURE__*/function (_Base4) {
  ...
  _createClass(Radius, [{
    ...
    value: function _update() {
      if (this.radiusName) {
        var radius = _globals_context__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A.theme.radius[this.radiusName];
...
var MiscProp = /*#__PURE__*/function (_Base5) {
  ...
  _createClass(MiscProp, [{
    ...
    value: function _update() {
      if (this.propName && this.propPath) {
        if (typeof this.propPath === 'string') {
          this._Text.content = "".concat(this.propName, ": ").concat(_globals_context__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A.theme[this.propPath]);
        } else if (this.propPath.length) {
          var val = _globals_context__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A.theme;
...
//# sourceMappingURL=docs-ThemingFoundations-stories.c4e251fc.iframe.bundle.js.map