...
import { DocsLink } from "../../utils/storybook/index.mdx";
...
provider|Promise<{ <br />&nbsp;&nbsp;items: <DocsLink id="lng.Component">lng.Component</DocsLink>, <br />&nbsp;&nbsp;appendItems: boolean <br />}>|false|used for providing additional items when scroll nears the end of the column
