...
If the array of items contains rows/columns with different heights and/or widths set autoResize to true so that the scroll bar is of the appropriate height.
