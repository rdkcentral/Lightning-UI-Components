...
| textStyle           | object                                                                              | false    | Xfinity theme       | font properties to apply to the title                                                                                                                                                                                                                         |
...
| textStyle      | number                                                                              | Default style of text to be displayed. Object should come from the current theme or contain any properties that the [Lightning text texture supports](https://lightningjs.io/docs/#/lightning-core-reference/RenderEngine/Textures/Text?id=properties). |
